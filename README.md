...
```sh
npm install git+ssh://git@github.com:stainless-sdks/nimbleway-typescript.git
```
...
```ts
import Nimbleway from 'npm:nimble-js';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/nimbleway-typescript/issues) with questions, bugs, or suggestions.
