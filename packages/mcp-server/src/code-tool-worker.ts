...
import { Nimble, ClientOptions } from '@nimble-way/nimble-js';
...
const fuse = new Fuse(
  [
    ...
    'client.extract.batch',
    'client.extract.run',
    'client.extract.templates.async',
    'client.extract.templates.batch',
    'client.extract.templates.delete',
    'client.extract.templates.get',
    'client.extract.templates.list',
    'client.extract.templates.run',
    'client.extract.templates.update',
    'client.extract.templates.generations.create',
    'client.extract.templates.generations.get',
    'client.extract.templates.versions.get',
    ...
    'client.agents.runs.streamEvents',
    'client.crawl.list',
    'client.crawl.run',
    'client.crawl.status',
    ...
    'client.jobs.list',
    'client.jobs.update',
    'client.jobs.runs.cancel',
    'client.jobs.runs.create',
    'client.jobs.runs.get',
    'client.jobs.runs.list',
    'client.jobs.runs.artifacts.downloadURL',
    'client.jobs.runs.artifacts.get',
    'client.jobs.runs.artifacts.list',
    'client.jobs.runs.artifacts.preview',
  ],
