...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/search \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "query": "x"\n        }\'',
      },
    },
  },
  {
    ...
    params: [
      'url: string;',
      'auto_driver_configuration?: object;',
      'body?: object;',
      ...
      'session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; };',
      'skill?: string | string[];',
      'state?: string;',
      'tag?: string;',
    ],
  ...
  },
  {
    ...
    response:
      "{ status: 'success'; task: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }; }",
    markdown:
      "## async\n\n`client.extract.async(url: string, auto_driver_configuration?: object, body?: object, browser?: 'chrome' | 'firefox' | { name: 'chrome' | 'firefox'; version?: string; }, browser_actions?: { auto_scroll: boolean | number | string | object; } | { click: string | string[] | object; } | { eval: string | object; } | { fetch: string | object; } | { fill: object | object; } | { get_cookies: boolean | object; } | { goto: string | object; } | { press: string | object; } | { screenshot: boolean | object; } | { scroll: number | string | object; } | { wait: number | string | object; } | { wait_for_element: string | string[] | object; } | { wait_for_navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2' | object; }[], callback_url?: string, city?: string, consent_header?: boolean, cookies?: { creation?: string; domain?: string; expires?: string; extensions?: string[]; hostOnly?: boolean; httpOnly?: boolean; lastAccessed?: string; maxAge?: 'Infinity' | '-Infinity' | number; name?: string; path?: string; pathIsDefault?: boolean; sameSite?: 'strict' | 'lax' | 'none'; secure?: boolean; value?: string; }[] | string, country?: string, device?: 'desktop' | 'mobile' | 'tablet', driver?: string, expected_status_codes?: number[], formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[], headers?: object, http2?: boolean, is_xhr?: boolean, locale?: string, markdown_backend?: 'full_page' | 'main_content', method?: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE', network_capture?: { method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { value: string; type?: 'exact' | 'contains'; }; validation?: boolean; wait_for_requests_count?: number; wait_for_requests_count_timeout?: number; }[], os?: 'windows' | 'mac os' | 'linux' | 'android' | 'ios', parse?: boolean, parser?: object | string, realtime_total_timeout?: number, referrer_type?: 'random' | 'no-referer' | 'same-origin' | 'google' | 'bing' | 'facebook' | 'twitter' | 'instagram', render?: boolean | 'auto', request_timeout?: number, session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; }, skill?: string | string[], state?: string, storage_compress?: boolean, storage_object_name?: string, storage_type?: string, storage_url?: string, tag?: string): { status: 'success'; task: object; }`\n\n**post** `/v2/extract/async`\n\nExtract Async Endpoint\n\n### Parameters\n\n- `url: string`\n  Target URL to scrape\n\n- `auto_driver_configuration?: object`\n  Custom flow for the optimization engine: maps candidate names to the number of attempts to spend on each candidate before advancing (0 skips it). Key order defines the flow order. Providing it opts the request into 'auto' driver selection.\n\n- `body?: object`\n  Request body for POST, PUT, PATCH methods\n\n- `browser?: 'chrome' | 'firefox' | { name: 'chrome' | 'firefox'; version?: string; }`\n  Browser type to emulate\n\n- `browser_actions?: { auto_scroll: boolean | number | string | { click_selector?: string | string[]; container?: string | string[]; delay_after_scroll?: number | string; idle_timeout?: number | string; loading_selector?: string | string[]; max_duration?: number | string; pause_on_selector?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; step_size?: number; }; } | { click: string | string[] | { selector: string | string[]; count?: number; delay?: number | string; offset_x?: number; offset_y?: number; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; steps?: number; strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; timeout?: number; visible?: boolean; }; } | { eval: string | { code: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fetch: string | { url: string; body?: string; headers?: object; method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fill: { selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; mode?: 'type'; mouse_movement_strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; typing_interval?: number | string; typing_strategy?: 'simple' | 'distribution'; visible?: boolean; } | { mode: 'paste'; selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { get_cookies: boolean | { required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { goto: string | { url: string; referer?: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; wait_until?: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; }; } | { press: string | { key: string; delay?: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { screenshot: boolean | { format?: 'png' | 'jpeg' | 'webp'; full_page?: boolean; quality?: number; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { scroll: number | string | { container?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; to?: string | string[]; visible?: boolean; x?: number; y?: number; }; } | { wait: number | string | { duration: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { wait_for_element: string | string[] | { selector: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { wait_for_navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2' | { navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; }[]`\n  Array of browser automation actions to execute sequentially\n\n- `callback_url?: string`\n  URL to call back when async operation completes\n\n- `city?: string`\n  City for geolocation\n\n- `consent_header?: boolean`\n  Whether to automatically handle cookie consent headers\n\n- `cookies?: { creation?: string; domain?: string; expires?: string; extensions?: string[]; hostOnly?: boolean; httpOnly?: boolean; lastAccessed?: string; maxAge?: 'Infinity' | '-Infinity' | number; name?: string; path?: string; pathIsDefault?: boolean; sameSite?: 'strict' | 'lax' | 'none'; secure?: boolean; value?: string; }[] | string`\n  Browser cookies as array of cookie objects\n\n- `country?: string`\n  Country code for geolocation and proxy selection\n\n- `device?: 'desktop' | 'mobile' | 'tablet'`\n  Device type for browser emulation\n\n- `driver?: string`\n  Browser driver to use\n\n- `expected_status_codes?: number[]`\n  Expected HTTP status codes for successful requests\n\n- `formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]`\n  List of acceptable response formats in order of preference\n\n- `headers?: object`\n  Custom HTTP headers to include in the request\n\n- `http2?: boolean`\n  Whether to use HTTP/2 protocol\n\n- `is_xhr?: boolean`\n  Whether to emulate XMLHttpRequest behavior\n\n- `locale?: string`\n  Locale for browser language and region settings\n\n- `markdown_backend?: 'full_page' | 'main_content'`\n  Selects which markdown conversion strategy to use. \"full_page\" converts the entire HTML page. \"main_content\" uses Mozilla Readability to extract the main article content before converting.\n\n- `method?: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE'`\n  HTTP method for the request\n\n- `network_capture?: { method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { value: string; type?: 'exact' | 'contains'; }; validation?: boolean; wait_for_requests_count?: number; wait_for_requests_count_timeout?: number; }[]`\n  Filters for capturing network traffic\n\n- `os?: 'windows' | 'mac os' | 'linux' | 'android' | 'ios'`\n  Operating system to emulate\n\n- `parse?: boolean`\n  Whether to parse the response content\n\n- `parser?: object | string`\n  Custom parser configuration as a key-value map\n\n- `realtime_total_timeout?: number`\n  Overall deadline in milliseconds for a realtime request. Clamped to the account total timeout — it can shorten the deadline but never extend it. Has no effect on async requests.\n\n- `referrer_type?: 'random' | 'no-referer' | 'same-origin' | 'google' | 'bing' | 'facebook' | 'twitter' | 'instagram'`\n  Referrer policy for the request\n\n- `render?: boolean | 'auto'`\n  Whether to render JavaScript content using a browser\n\n- `request_timeout?: number`\n  Request timeout in milliseconds\n\n- `session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; }`\n  - `id?: string`\n  - `prefetch_userbrowser?: boolean`\n  - `renew_on_blocked?: boolean`\n  - `retry?: boolean`\n  - `timeout?: number`\n\n- `skill?: string | string[]`\n  Skills or capabilities required for the request\n\n- `state?: string`\n  US state for geolocation (only valid when country is US)\n\n- `storage_compress?: boolean`\n  Whether to compress stored data\n\n- `storage_object_name?: string`\n  Custom name for the stored object\n\n- `storage_type?: string`\n  Type of storage to use for results\n\n- `storage_url?: string`\n  URL for storage location\n\n- `tag?: string`\n  User-defined tag for request identification\n\n### Returns\n\n- `{ status: 'success'; task: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }; }`\n  Response when an async extract task is created successfully.\n\n  - `status: 'success'`\n  - `task: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.extract.async({ url: 'url' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.async',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.extract.async({ url: 'url' });\n\nconsole.log(response.status);",
      },
      python: {
        method: 'extract.async_',
        example:
      ...
      go: {
        method: 'client.Extract.Async',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Extract.Async(context.TODO(), githubcomnimblewaynimblego.ExtractAsyncParams{\n\t\tURL: "url",\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Status)\n}\n',
      },
      cli: {
        method: 'extract async',
        example: "nimble extract async \\\n  --api-key 'My API Key' \\\n  --url url",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/async \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "url": "url",\n          "auto_driver_configuration": {\n            "vx10": 2,\n            "vx10-pro": 0,\n            "vx6-fast": 1,\n            "vx6-stealth": 1,\n            "vx8": 5,\n            "vx8-pro": 5\n          },\n          "body": {\n            "key": "value"\n          },\n          "browser_actions": [\n            {\n              "goto": "https://example.com/login"\n            },\n            {\n              "wait_for_element": "#login-form"\n            },\n            {\n              "fill": {\n                "selector": "#username",\n                "value": "user@example.com",\n                "mode": "type"\n              }\n            },\n            {\n              "fill": {\n                "selector": "#password",\n                "value": "password123",\n                "mode": "type"\n              }\n            },\n            {\n              "click": "#submit"\n            },\n            {\n              "screenshot": {\n                "full_page": true\n              }\n            }\n          ],\n          "callback_url": "https://example.com/webhook/callback",\n          "city": "Los Angeles",\n          "country": "US",\n          "device": "desktop",\n          "driver": "vx8",\n          "expected_status_codes": [\n            200,\n            201\n          ],\n          "formats": [\n            "html"\n          ],\n          "headers": {\n            "Accept-Language": "en-US",\n            "User-Agent": "CustomBot/1.0"\n          },\n          "http2": true,\n          "is_xhr": true,\n          "locale": "en-US",\n          "markdown_backend": "full_page",\n          "method": "GET",\n          "os": "windows",\n          "parse": true,\n          "parser": {\n            "myParser": "bar"\n          },\n          "realtime_total_timeout": 15000,\n          "referrer_type": "random",\n          "render": true,\n          "request_timeout": 30000,\n          "state": "CA",\n          "storage_compress": true,\n          "storage_object_name": "result-2024-01-15.json",\n          "storage_type": "s3",\n          "storage_url": "s3://bucket-name/path/to/object",\n          "tag": "campaign-2024-q1"\n        }\'',
      },
    },
  },
  {
    name: 'batch',
    endpoint: '/v2/extract/batch',
    httpMethod: 'post',
    summary: 'Extract Batch Endpoint',
    description: 'Extract Batch Endpoint',
    stainlessPath: '(resource) extract > (method) batch',
    qualified: 'client.extract.batch',
    params: [
      "inputs: { auto_driver_configuration?: object; body?: object; browser?: 'chrome' | 'firefox' | { name: 'chrome' | 'firefox'; version?: string; }; browser_actions?: { auto_scroll: boolean | number | string | { click_selector?: string | string[]; container?: string | string[]; delay_after_scroll?: number | string; idle_timeout?: number | string; loading_selector?: string | string[]; max_duration?: number | string; pause_on_selector?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; step_size?: number; }; } | { click: string | string[] | { selector: string | string[]; count?: number; delay?: number | string; offset_x?: number; offset_y?: number; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; steps?: number; strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; timeout?: number; visible?: boolean; }; } | { eval: string | { code: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fetch: string | { url: string; body?: string; headers?: object; method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fill: { selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; mode?: 'type'; mouse_movement_strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; typing_interval?: number | string; typing_strategy?: 'simple' | 'distribution'; visible?: boolean; } | { mode: 'paste'; selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { get_cookies: boolean | { required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { goto: string | { url: string; referer?: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; wait_until?: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; }; } | { press: string | { key: string; delay?: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { screenshot: boolean | { format?: 'png' | 'jpeg' | 'webp'; full_page?: boolean; quality?: number; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { scroll: number | string | { container?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; to?: string | string[]; visible?: boolean; x?: number; y?: number; }; } | { wait: number | string | { duration: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { wait_for_element: string | string[] | { selector: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { wait_for_navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2' | { navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; }[]; callback_url?: string; city?: string; consent_header?: boolean; cookies?: { creation?: string; domain?: string; expires?: string; extensions?: string[]; hostOnly?: boolean; httpOnly?: boolean; lastAccessed?: string; maxAge?: 'Infinity' | '-Infinity' | number; name?: string; path?: string; pathIsDefault?: boolean; sameSite?: 'strict' | 'lax' | 'none'; secure?: boolean; value?: string; }[] | string; country?: string; device?: 'desktop' | 'mobile' | 'tablet'; driver?: string; expected_status_codes?: number[]; formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; headers?: object; http2?: boolean; is_xhr?: boolean; locale?: string; markdown_backend?: 'full_page' | 'main_content'; method?: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE'; network_capture?: { method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { value: string; type?: 'exact' | 'contains'; }; validation?: boolean; wait_for_requests_count?: number; wait_for_requests_count_timeout?: number; }[]; os?: 'windows' | 'mac os' | 'linux' | 'android' | 'ios'; parse?: boolean; parser?: object | string; realtime_total_timeout?: number; referrer_type?: 'random' | 'no-referer' | 'same-origin' | 'google' | 'bing' | 'facebook' | 'twitter' | 'instagram'; render?: boolean | 'auto'; request_timeout?: number; session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; }; skill?: string | string[]; state?: string; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; tag?: string; url?: string; }[];",
      "shared_inputs?: { auto_driver_configuration?: object; body?: object; browser?: 'chrome' | 'firefox' | { name: 'chrome' | 'firefox'; version?: string; }; browser_actions?: { auto_scroll: boolean | number | string | { click_selector?: string | string[]; container?: string | string[]; delay_after_scroll?: number | string; idle_timeout?: number | string; loading_selector?: string | string[]; max_duration?: number | string; pause_on_selector?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; step_size?: number; }; } | { click: string | string[] | { selector: string | string[]; count?: number; delay?: number | string; offset_x?: number; offset_y?: number; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; steps?: number; strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; timeout?: number; visible?: boolean; }; } | { eval: string | { code: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fetch: string | { url: string; body?: string; headers?: object; method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fill: { selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; mode?: 'type'; mouse_movement_strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; typing_interval?: number | string; typing_strategy?: 'simple' | 'distribution'; visible?: boolean; } | { mode: 'paste'; selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { get_cookies: boolean | { required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { goto: string | { url: string; referer?: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; wait_until?: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; }; } | { press: string | { key: string; delay?: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { screenshot: boolean | { format?: 'png' | 'jpeg' | 'webp'; full_page?: boolean; quality?: number; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { scroll: number | string | { container?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; to?: string | string[]; visible?: boolean; x?: number; y?: number; }; } | { wait: number | string | { duration: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { wait_for_element: string | string[] | { selector: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { wait_for_navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2' | { navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; }[]; callback_url?: string; city?: string; consent_header?: boolean; cookies?: { creation?: string; domain?: string; expires?: string; extensions?: string[]; hostOnly?: boolean; httpOnly?: boolean; lastAccessed?: string; maxAge?: 'Infinity' | '-Infinity' | number; name?: string; path?: string; pathIsDefault?: boolean; sameSite?: 'strict' | 'lax' | 'none'; secure?: boolean; value?: string; }[] | string; country?: string; device?: 'desktop' | 'mobile' | 'tablet'; driver?: string; expected_status_codes?: number[]; formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; headers?: object; http2?: boolean; is_xhr?: boolean; locale?: string; markdown_backend?: 'full_page' | 'main_content'; method?: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE'; network_capture?: { method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { value: string; type?: 'exact' | 'contains'; }; validation?: boolean; wait_for_requests_count?: number; wait_for_requests_count_timeout?: number; }[]; os?: 'windows' | 'mac os' | 'linux' | 'android' | 'ios'; parse?: boolean; parser?: object | string; realtime_total_timeout?: number; referrer_type?: 'random' | 'no-referer' | 'same-origin' | 'google' | 'bing' | 'facebook' | 'twitter' | 'instagram'; render?: boolean | 'auto'; request_timeout?: number; session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; }; skill?: string | string[]; state?: string; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; tag?: string; url?: string; };",
    ],
    response:
      "{ batch_id: string; batch_size: number; tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]; }",
    markdown:
      "## batch\n\n`client.extract.batch(inputs: { auto_driver_configuration?: object; body?: object; browser?: 'chrome' | 'firefox' | { name: 'chrome' | 'firefox'; version?: string; }; browser_actions?: object | object | object | object | object | object | object | object | object | object | object | object | object[]; callback_url?: string; city?: string; consent_header?: boolean; cookies?: { creation?: string; domain?: string; expires?: string; extensions?: string[]; hostOnly?: boolean; httpOnly?: boolean; lastAccessed?: string; maxAge?: 'Infinity' | '-Infinity' | number; name?: string; path?: string; pathIsDefault?: boolean; sameSite?: 'strict' | 'lax' | 'none'; secure?: boolean; value?: string; }[] | string; country?: string; device?: 'desktop' | 'mobile' | 'tablet'; driver?: string; expected_status_codes?: number[]; formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; headers?: object; http2?: boolean; is_xhr?: boolean; locale?: string; markdown_backend?: 'full_page' | 'main_content'; method?: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE'; network_capture?: { method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: object; validation?: boolean; wait_for_requests_count?: number; wait_for_requests_count_timeout?: number; }[]; os?: 'windows' | 'mac os' | 'linux' | 'android' | 'ios'; parse?: boolean; parser?: object | string; realtime_total_timeout?: number; referrer_type?: 'random' | 'no-referer' | 'same-origin' | 'google' | 'bing' | 'facebook' | 'twitter' | 'instagram'; render?: boolean | 'auto'; request_timeout?: number; session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; }; skill?: string | string[]; state?: string; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; tag?: string; url?: string; }[], shared_inputs?: { auto_driver_configuration?: object; body?: object; browser?: 'chrome' | 'firefox' | { name: 'chrome' | 'firefox'; version?: string; }; browser_actions?: object | object | object | object | object | object | object | object | object | object | object | object | object[]; callback_url?: string; city?: string; consent_header?: boolean; cookies?: { creation?: string; domain?: string; expires?: string; extensions?: string[]; hostOnly?: boolean; httpOnly?: boolean; lastAccessed?: string; maxAge?: 'Infinity' | '-Infinity' | number; name?: string; path?: string; pathIsDefault?: boolean; sameSite?: 'strict' | 'lax' | 'none'; secure?: boolean; value?: string; }[] | string; country?: string; device?: 'desktop' | 'mobile' | 'tablet'; driver?: string; expected_status_codes?: number[]; formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; headers?: object; http2?: boolean; is_xhr?: boolean; locale?: string; markdown_backend?: 'full_page' | 'main_content'; method?: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE'; network_capture?: { method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: object; validation?: boolean; wait_for_requests_count?: number; wait_for_requests_count_timeout?: number; }[]; os?: 'windows' | 'mac os' | 'linux' | 'android' | 'ios'; parse?: boolean; parser?: object | string; realtime_total_timeout?: number; referrer_type?: 'random' | 'no-referer' | 'same-origin' | 'google' | 'bing' | 'facebook' | 'twitter' | 'instagram'; render?: boolean | 'auto'; request_timeout?: number; session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; }; skill?: string | string[]; state?: string; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; tag?: string; url?: string; }): { batch_id: string; batch_size: number; tasks: object[]; }`\n\n**post** `/v2/extract/batch`\n\nExtract Batch Endpoint\n\n### Parameters\n\n- `inputs: { auto_driver_configuration?: object; body?: object; browser?: 'chrome' | 'firefox' | { name: 'chrome' | 'firefox'; version?: string; }; browser_actions?: { auto_scroll: boolean | number | string | { click_selector?: string | string[]; container?: string | string[]; delay_after_scroll?: number | string; idle_timeout?: number | string; loading_selector?: string | string[]; max_duration?: number | string; pause_on_selector?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; step_size?: number; }; } | { click: string | string[] | { selector: string | string[]; count?: number; delay?: number | string; offset_x?: number; offset_y?: number; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; steps?: number; strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; timeout?: number; visible?: boolean; }; } | { eval: string | { code: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fetch: string | { url: string; body?: string; headers?: object; method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fill: { selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; mode?: 'type'; mouse_movement_strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; typing_interval?: number | string; typing_strategy?: 'simple' | 'distribution'; visible?: boolean; } | { mode: 'paste'; selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { get_cookies: boolean | { required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { goto: string | { url: string; referer?: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; wait_until?: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; }; } | { press: string | { key: string; delay?: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { screenshot: boolean | { format?: 'png' | 'jpeg' | 'webp'; full_page?: boolean; quality?: number; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { scroll: number | string | { container?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; to?: string | string[]; visible?: boolean; x?: number; y?: number; }; } | { wait: number | string | { duration: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { wait_for_element: string | string[] | { selector: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { wait_for_navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2' | { navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; }[]; callback_url?: string; city?: string; consent_header?: boolean; cookies?: { creation?: string; domain?: string; expires?: string; extensions?: string[]; hostOnly?: boolean; httpOnly?: boolean; lastAccessed?: string; maxAge?: 'Infinity' | '-Infinity' | number; name?: string; path?: string; pathIsDefault?: boolean; sameSite?: 'strict' | 'lax' | 'none'; secure?: boolean; value?: string; }[] | string; country?: string; device?: 'desktop' | 'mobile' | 'tablet'; driver?: string; expected_status_codes?: number[]; formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; headers?: object; http2?: boolean; is_xhr?: boolean; locale?: string; markdown_backend?: 'full_page' | 'main_content'; method?: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE'; network_capture?: { method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { value: string; type?: 'exact' | 'contains'; }; validation?: boolean; wait_for_requests_count?: number; wait_for_requests_count_timeout?: number; }[]; os?: 'windows' | 'mac os' | 'linux' | 'android' | 'ios'; parse?: boolean; parser?: object | string; realtime_total_timeout?: number; referrer_type?: 'random' | 'no-referer' | 'same-origin' | 'google' | 'bing' | 'facebook' | 'twitter' | 'instagram'; render?: boolean | 'auto'; request_timeout?: number; session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; }; skill?: string | string[]; state?: string; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; tag?: string; url?: string; }[]`\n  Array of extraction requests. Each object can include extraction parameters and async/storage settings.\n\n- `shared_inputs?: { auto_driver_configuration?: object; body?: object; browser?: 'chrome' | 'firefox' | { name: 'chrome' | 'firefox'; version?: string; }; browser_actions?: { auto_scroll: boolean | number | string | { click_selector?: string | string[]; container?: string | string[]; delay_after_scroll?: number | string; idle_timeout?: number | string; loading_selector?: string | string[]; max_duration?: number | string; pause_on_selector?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; step_size?: number; }; } | { click: string | string[] | { selector: string | string[]; count?: number; delay?: number | string; offset_x?: number; offset_y?: number; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; steps?: number; strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; timeout?: number; visible?: boolean; }; } | { eval: string | { code: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fetch: string | { url: string; body?: string; headers?: object; method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fill: { selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; mode?: 'type'; mouse_movement_strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; typing_interval?: number | string; typing_strategy?: 'simple' | 'distribution'; visible?: boolean; } | { mode: 'paste'; selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { get_cookies: boolean | { required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { goto: string | { url: string; referer?: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; wait_until?: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; }; } | { press: string | { key: string; delay?: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { screenshot: boolean | { format?: 'png' | 'jpeg' | 'webp'; full_page?: boolean; quality?: number; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { scroll: number | string | { container?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; to?: string | string[]; visible?: boolean; x?: number; y?: number; }; } | { wait: number | string | { duration: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { wait_for_element: string | string[] | { selector: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { wait_for_navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2' | { navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; }[]; callback_url?: string; city?: string; consent_header?: boolean; cookies?: { creation?: string; domain?: string; expires?: string; extensions?: string[]; hostOnly?: boolean; httpOnly?: boolean; lastAccessed?: string; maxAge?: 'Infinity' | '-Infinity' | number; name?: string; path?: string; pathIsDefault?: boolean; sameSite?: 'strict' | 'lax' | 'none'; secure?: boolean; value?: string; }[] | string; country?: string; device?: 'desktop' | 'mobile' | 'tablet'; driver?: string; expected_status_codes?: number[]; formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; headers?: object; http2?: boolean; is_xhr?: boolean; locale?: string; markdown_backend?: 'full_page' | 'main_content'; method?: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE'; network_capture?: { method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { value: string; type?: 'exact' | 'contains'; }; validation?: boolean; wait_for_requests_count?: number; wait_for_requests_count_timeout?: number; }[]; os?: 'windows' | 'mac os' | 'linux' | 'android' | 'ios'; parse?: boolean; parser?: object | string; realtime_total_timeout?: number; referrer_type?: 'random' | 'no-referer' | 'same-origin' | 'google' | 'bing' | 'facebook' | 'twitter' | 'instagram'; render?: boolean | 'auto'; request_timeout?: number; session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; }; skill?: string | string[]; state?: string; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; tag?: string; url?: string; }`\n  Shared parameters applied to the entire batch. Can include extraction parameters and async/storage settings.\n  - `auto_driver_configuration?: object`\n    Custom flow for the optimization engine: maps candidate names to the number of attempts to spend on each candidate before advancing (0 skips it). Key order defines the flow order. Providing it opts the request into 'auto' driver selection.\n  - `body?: object`\n    Request body for POST, PUT, PATCH methods\n  - `browser?: 'chrome' | 'firefox' | { name: 'chrome' | 'firefox'; version?: string; }`\n    Browser type to emulate\n  - `browser_actions?: { auto_scroll: boolean | number | string | { click_selector?: string | string[]; container?: string | string[]; delay_after_scroll?: number | string; idle_timeout?: number | string; loading_selector?: string | string[]; max_duration?: number | string; pause_on_selector?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; step_size?: number; }; } | { click: string | string[] | { selector: string | string[]; count?: number; delay?: number | string; offset_x?: number; offset_y?: number; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; steps?: number; strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; timeout?: number; visible?: boolean; }; } | { eval: string | { code: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fetch: string | { url: string; body?: string; headers?: object; method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fill: { selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; mode?: 'type'; mouse_movement_strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; typing_interval?: number | string; typing_strategy?: 'simple' | 'distribution'; visible?: boolean; } | { mode: 'paste'; selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { get_cookies: boolean | { required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { goto: string | { url: string; referer?: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; wait_until?: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; }; } | { press: string | { key: string; delay?: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { screenshot: boolean | { format?: 'png' | 'jpeg' | 'webp'; full_page?: boolean; quality?: number; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { scroll: number | string | { container?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; to?: string | string[]; visible?: boolean; x?: number; y?: number; }; } | { wait: number | string | { duration: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { wait_for_element: string | string[] | { selector: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { wait_for_navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2' | { navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; }[]`\n    Array of browser automation actions to execute sequentially\n  - `callback_url?: string`\n    URL to call back when async operation completes\n  - `city?: string`\n    City for geolocation\n  - `consent_header?: boolean`\n    Whether to automatically handle cookie consent headers\n  - `cookies?: { creation?: string; domain?: string; expires?: string; extensions?: string[]; hostOnly?: boolean; httpOnly?: boolean; lastAccessed?: string; maxAge?: 'Infinity' | '-Infinity' | number; name?: string; path?: string; pathIsDefault?: boolean; sameSite?: 'strict' | 'lax' | 'none'; secure?: boolean; value?: string; }[] | string`\n    Browser cookies as array of cookie objects\n  - `country?: string`\n    Country code for geolocation and proxy selection\n  - `device?: 'desktop' | 'mobile' | 'tablet'`\n    Device type for browser emulation\n  - `driver?: string`\n    Browser driver to use. Use 'auto' to let the engine select the candidate config per domain.\n  - `expected_status_codes?: number[]`\n    Expected HTTP status codes for successful requests\n  - `formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]`\n    List of acceptable response formats in order of preference\n  - `headers?: object`\n    Custom HTTP headers to include in the request\n  - `http2?: boolean`\n    Whether to use HTTP/2 protocol\n  - `is_xhr?: boolean`\n    Whether to emulate XMLHttpRequest behavior\n  - `locale?: string`\n    Locale for browser language and region settings\n  - `markdown_backend?: 'full_page' | 'main_content'`\n    Selects which markdown conversion strategy to use. \"full_page\" converts the entire HTML page. \"main_content\" uses Mozilla Readability to extract the main article content before converting.\n  - `method?: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE'`\n    HTTP method for the request\n  - `network_capture?: { method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { value: string; type?: 'exact' | 'contains'; }; validation?: boolean; wait_for_requests_count?: number; wait_for_requests_count_timeout?: number; }[]`\n    Filters for capturing network traffic\n  - `os?: 'windows' | 'mac os' | 'linux' | 'android' | 'ios'`\n    Operating system to emulate\n  - `parse?: boolean`\n    Whether to parse the response content\n  - `parser?: object | string`\n    Custom parser configuration as a key-value map\n  - `realtime_total_timeout?: number`\n    Overall deadline in milliseconds for a realtime request. Clamped to the account total timeout — it can shorten the deadline but never extend it. Has no effect on async requests.\n  - `referrer_type?: 'random' | 'no-referer' | 'same-origin' | 'google' | 'bing' | 'facebook' | 'twitter' | 'instagram'`\n    Referrer policy for the request\n  - `render?: boolean | 'auto'`\n    Whether to render JavaScript content using a browser. Use 'auto' to let the engine select the candidate config per domain.\n  - `request_timeout?: number`\n    Request timeout in milliseconds\n  - `session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; }`\n  - `skill?: string | string[]`\n    Skills or capabilities required for the request\n  - `state?: string`\n    US state for geolocation (only valid when country is US)\n  - `storage_compress?: boolean`\n    Whether to compress stored data\n  - `storage_object_name?: string`\n    Custom name for the stored object\n  - `storage_type?: string`\n    Type of storage to use for results\n  - `storage_url?: string`\n    URL for storage location\n  - `tag?: string`\n    User-defined tag for request identification\n  - `url?: string`\n    Target URL to scrape\n\n### Returns\n\n- `{ batch_id: string; batch_size: number; tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]; }`\n  Response when a batch of extract tasks is created successfully.\n\n  - `batch_id: string`\n  - `batch_size: number`\n  - `tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.extract.batch({ inputs: [{}] });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.batch',
        example:
      ...
      go: {
        method: 'client.Extract.Batch',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Extract.Batch(context.TODO(), githubcomnimblewaynimblego.ExtractBatchParams{\n\t\tInputs: []githubcomnimblewaynimblego.ExtractBatchParamsInput{{}},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.BatchID)\n}\n',
      },
      cli: {
        method: 'extract batch',
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/batch \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "inputs": [\n            {}\n          ]\n        }\'',
      },
    },
  },
  {
    name: 'run',
    endpoint: '/v2/extract/templates/run',
    httpMethod: 'post',
    summary: '',
    description: 'Execute Extraction Template Realtime Endpoint',
    stainlessPath: '(resource) extract.templates > (method) run',
    qualified: 'client.extract.templates.run',
    params: [
      'params: object;',
      'template: string;',
      "formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[];",
    ...
    response:
      "{ data: { browser_actions?: { results: object[]; success: boolean; total_duration: number; }; cookies?: object[]; eval?: object[]; fetch?: object[]; headers?: object; html?: string; links?: string[]; markdown?: string; network_capture?: { filter: object; results: object[]; errorMessage?: string; }[]; pages_html?: string[]; parsing?: { entities: object; status: 'success'; } | { error: string; status: 'error'; } | object; redirects?: { status_code: number; url: string; }[]; screenshots?: object[]; }; metadata: { agent?: string; driver?: string; localization_id?: string; query_duration?: number; query_time?: string; response_parameters?: object; tag?: string; }; status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'; task_id: string; url: string; debug?: { performance_metrics?: object; proxy_total_bytes_usage?: number; transformed_output?: object; userbrowser?: object; }; pagination?: { next_page_params: object; } | { next_page_params: object; }[]; status_code?: number; warnings?: string[]; }",
    markdown:
      "## run\n\n`client.extract.templates.run(params: object, template: string, formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[], localization?: boolean): { data: object; metadata: object; status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'; task_id: string; url: string; debug?: object; pagination?: object | object[]; status_code?: number; warnings?: string[]; }`\n\n**post** `/v2/extract/templates/run`\n\nExecute Extraction Template Realtime Endpoint\n\n### Parameters\n\n- `params: object`\n\n- `template: string`\n\n- `formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]`\n  Response formats to include. All disabled by default.\n\n- `localization?: boolean`\n\n### Returns\n\n- `{ data: { browser_actions?: { results: object[]; success: boolean; total_duration: number; }; cookies?: object[]; eval?: object[]; fetch?: object[]; headers?: object; html?: string; links?: string[]; markdown?: string; network_capture?: { filter: object; results: object[]; errorMessage?: string; }[]; pages_html?: string[]; parsing?: { entities: object; status: 'success'; } | { error: string; status: 'error'; } | object; redirects?: { status_code: number; url: string; }[]; screenshots?: object[]; }; metadata: { agent?: string; driver?: string; localization_id?: string; query_duration?: number; query_time?: string; response_parameters?: object; tag?: string; }; status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'; task_id: string; url: string; debug?: { performance_metrics?: object; proxy_total_bytes_usage?: number; transformed_output?: object; userbrowser?: object; }; pagination?: { next_page_params: object; } | { next_page_params: object; }[]; status_code?: number; warnings?: string[]; }`\n\n  - `data: { browser_actions?: { results: { duration: number; name: string; status: 'no-run' | 'in-progress' | 'done' | 'error' | 'skipped'; error?: string; result?: object; }[]; success: boolean; total_duration: number; }; cookies?: object[]; eval?: object[]; fetch?: object[]; headers?: object; html?: string; links?: string[]; markdown?: string; network_capture?: { filter: { validation: boolean; wait_for_requests_count: number; method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { type: 'exact' | 'contains'; value: string; }; wait_for_requests_count_timeout?: number; }; results: { request: { headers: object; method: string; resource_type: string; url: string; body?: string; }; response: { body: string; headers: object; serialization: 'none' | 'base64'; status: number; status_text: string; }; }[]; errorMessage?: string; }[]; pages_html?: string[]; parsing?: { entities: object; status: 'success'; } | { error: string; status: 'error'; } | object; redirects?: { status_code: number; url: string; }[]; screenshots?: object[]; }`\n  - `metadata: { agent?: string; driver?: string; localization_id?: string; query_duration?: number; query_time?: string; response_parameters?: object; tag?: string; }`\n  - `status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'`\n  - `task_id: string`\n  - `url: string`\n  - `debug?: { performance_metrics?: object; proxy_total_bytes_usage?: number; transformed_output?: object; userbrowser?: object; }`\n  - `pagination?: { next_page_params: object; } | { next_page_params: object; }[]`\n  - `status_code?: number`\n  - `warnings?: string[]`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.extract.templates.run({\n  params: { foo: 'bar' },\n  template: 'template',\n});\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.run',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.extract.templates.run({\n  params: { foo: 'bar' },\n  template: 'template',\n});\n\nconsole.log(response.task_id);",
      },
      python: {
        method: 'extract.templates.run',
        example:
          'import os\nfrom nimble_python import Nimble\n\nclient = Nimble(\n    api_key=os.environ.get("NIMBLE_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.extract.templates.run(\n    params={\n        "foo": "bar"\n    },\n    template="template",\n)\nprint(response.task_id)',
      },
      go: {
        method: 'client.Extract.Templates.Run',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Extract.Templates.Run(context.TODO(), githubcomnimblewaynimblego.ExtractTemplateRunParams{\n\t\tParams: map[string]any{\n\t\t\t"foo": "bar",\n\t\t},\n\t\tTemplate: "template",\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.TaskID)\n}\n',
      },
      cli: {
        method: 'templates run',
        example:
          "nimble extract:templates run \\\n  --api-key 'My API Key' \\\n  --params '{foo: bar}' \\\n  --template template",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/templates/run \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "params": {\n            "foo": "bar"\n          },\n          "template": "template",\n          "formats": [\n            "html",\n            "markdown"\n          ]\n        }\'',
      },
    },
  },
  {
    name: 'async',
    endpoint: '/v2/extract/templates/async',
    httpMethod: 'post',
    summary: '',
    description: 'Execute Extraction Template Async Endpoint',
    stainlessPath: '(resource) extract.templates > (method) async',
    qualified: 'client.extract.templates.async',
    params: [
      'params: object;',
      'template: string;',
      'callback_url?: string;',
    ...
    markdown:
      "## async\n\n`client.extract.templates.async(params: object, template: string, callback_url?: string, formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[], localization?: boolean, storage_compress?: boolean, storage_object_name?: string, storage_type?: string, storage_url?: string): { status: 'success'; task: object; }`\n\n**post** `/v2/extract/templates/async`\n\nExecute Extraction Template Async Endpoint\n\n### Parameters\n\n- `params: object`\n\n- `template: string`\n\n- `callback_url?: string`\n  URL to call back when async operation completes\n\n- `formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]`\n  Response formats to include. All disabled by default.\n\n- `localization?: boolean`\n\n- `storage_compress?: boolean`\n  Whether to compress stored data\n\n- `storage_object_name?: string`\n  Custom name for the stored object\n\n- `storage_type?: string`\n  Type of storage to use for results\n\n- `storage_url?: string`\n  URL for storage location\n\n### Returns\n\n- `{ status: 'success'; task: object; }`\n\n  - `status: 'success'`\n  - `task: object`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.extract.templates.async({\n  params: { foo: 'bar' },\n  template: 'template',\n});\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.async',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.extract.templates.async({\n  params: { foo: 'bar' },\n  template: 'template',\n});\n\nconsole.log(response.status);",
      },
      python: {
        method: 'extract.templates.async_',
        example:
          'import os\nfrom nimble_python import Nimble\n\nclient = Nimble(\n    api_key=os.environ.get("NIMBLE_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.extract.templates.async_(\n    params={\n        "foo": "bar"\n    },\n    template="template",\n)\nprint(response.status)',
      },
      go: {
        method: 'client.Extract.Templates.Async',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Extract.Templates.Async(context.TODO(), githubcomnimblewaynimblego.ExtractTemplateAsyncParams{\n\t\tParams: map[string]any{\n\t\t\t"foo": "bar",\n\t\t},\n\t\tTemplate: "template",\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Status)\n}\n',
      },
      cli: {
        method: 'templates async',
        example:
          "nimble extract:templates async \\\n  --api-key 'My API Key' \\\n  --params '{foo: bar}' \\\n  --template template",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/templates/async \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "params": {\n            "foo": "bar"\n          },\n          "template": "template",\n          "callback_url": "https://example.com/webhook/callback",\n          "formats": [\n            "html",\n            "markdown"\n          ],\n          "storage_compress": true,\n          "storage_object_name": "result-2024-01-15.json",\n          "storage_type": "s3",\n          "storage_url": "s3://bucket-name/path/to/object"\n        }\'',
      },
    },
  },
  {
    name: 'batch',
    endpoint: '/v2/extract/templates/batch',
    httpMethod: 'post',
    summary: '',
    description: 'Execute Extraction Template Batch Endpoint',
    stainlessPath: '(resource) extract.templates > (method) batch',
    qualified: 'client.extract.templates.batch',
    params: [
      "inputs: { formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; localization?: boolean; params?: object; }[];",
      "shared_inputs: { template: string; formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; localization?: boolean; params?: object; };",
    ],
    response:
      "{ batch_id: string; batch_size: number; tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]; }",
    markdown:
      "## batch\n\n`client.extract.templates.batch(inputs: { formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; localization?: boolean; params?: object; }[], shared_inputs: { template: string; formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; localization?: boolean; params?: object; }): { batch_id: string; batch_size: number; tasks: object[]; }`\n\n**post** `/v2/extract/templates/batch`\n\nExecute Extraction Template Batch Endpoint\n\n### Parameters\n\n- `inputs: { formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; localization?: boolean; params?: object; }[]`\n\n- `shared_inputs: { template: string; formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; localization?: boolean; params?: object; }`\n  - `template: string`\n  - `formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]`\n    Response formats to include. All disabled by default.\n  - `localization?: boolean`\n  - `params?: object`\n\n### Returns\n\n- `{ batch_id: string; batch_size: number; tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]; }`\n  Response when a batch of extract tasks is created successfully.\n\n  - `batch_id: string`\n  - `batch_size: number`\n  - `tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.extract.templates.batch({\n  inputs: [{}],\n  shared_inputs: { template: 'template' },\n});\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.batch',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.extract.templates.batch({\n  inputs: [{}],\n  shared_inputs: { template: 'template' },\n});\n\nconsole.log(response.batch_id);",
      },
      python: {
        method: 'extract.templates.batch',
        example:
          'import os\nfrom nimble_python import Nimble\n\nclient = Nimble(\n    api_key=os.environ.get("NIMBLE_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.extract.templates.batch(\n    inputs=[{}],\n    shared_inputs={\n        "template": "template"\n    },\n)\nprint(response.batch_id)',
      },
      go: {
        method: 'client.Extract.Templates.Batch',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Extract.Templates.Batch(context.TODO(), githubcomnimblewaynimblego.ExtractTemplateBatchParams{\n\t\tInputs: []githubcomnimblewaynimblego.ExtractTemplateBatchParamsInput{{}},\n\t\tSharedInputs: githubcomnimblewaynimblego.ExtractTemplateBatchParamsSharedInputs{\n\t\t\tTemplate: "template",\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.BatchID)\n}\n',
      },
      cli: {
        method: 'templates batch',
        example:
          "nimble extract:templates batch \\\n  --api-key 'My API Key' \\\n  --input '{}' \\\n  --shared-inputs '{template: template}'",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/templates/batch \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "inputs": [\n            {}\n          ],\n          "shared_inputs": {\n            "template": "template"\n          }\n        }\'',
      },
    },
  },
  {
    name: 'get',
    endpoint: '/v2/extract/templates/{extract_template_name}',
    httpMethod: 'get',
    summary: 'Get Extract Template Public V2',
    description: 'Get Extract Template Public V2',
    stainlessPath: '(resource) extract.templates > (method) get',
    qualified: 'client.extract.templates.get',
    params: ['extract_template_name: string;'],
    response:
      '{ id: string; created_at: string; name: string; updated_at: string; published_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }; published_version_id?: string; }',
    markdown:
      "## get\n\n`client.extract.templates.get(extract_template_name: string): { id: string; created_at: string; name: string; updated_at: string; published_version?: object; published_version_id?: string; }`\n\n**get** `/v2/extract/templates/{extract_template_name}`\n\nGet Extract Template Public V2\n\n### Parameters\n\n- `extract_template_name: string`\n\n### Returns\n\n- `{ id: string; created_at: string; name: string; updated_at: string; published_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }; published_version_id?: string; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `name: string`\n  - `updated_at: string`\n  - `published_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }`\n  - `published_version_id?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst template = await client.extract.templates.get('extract_template_name');\n\nconsole.log(template);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.get',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst template = await client.extract.templates.get('extract_template_name');\n\nconsole.log(template.id);",
      },
      python: {
        method: 'extract.templates.get',
        example:
      ...
      go: {
        method: 'client.Extract.Templates.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\ttemplate, err := client.Extract.Templates.Get(context.TODO(), "extract_template_name")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", template.ID)\n}\n',
      },
      cli: {
        method: 'templates get',
        example:
          "nimble extract:templates get \\\n  --api-key 'My API Key' \\\n  --extract-template-name extract_template_name",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/templates/$EXTRACT_TEMPLATE_NAME \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    name: 'list',
    endpoint: '/v2/extract/templates',
    httpMethod: 'get',
    summary: 'List Extract Templates Public V2',
    description: 'List Extract Templates Public V2',
    stainlessPath: '(resource) extract.templates > (method) list',
    qualified: 'client.extract.templates.list',
    params: ['limit?: number;', 'offset?: number;'],
    response:
      '{ items: { id: string; created_at: string; name: string; updated_at: string; published_version?: { id: string; created_at: string; input_schema: object; metadata: object; name: string; output_schema: object; version_number: number; samples?: object[]; }; published_version_id?: string; }[]; limit: number; offset: number; total: number; }',
    markdown:
      "## list\n\n`client.extract.templates.list(limit?: number, offset?: number): { items: object[]; limit: number; offset: number; total: number; }`\n\n**get** `/v2/extract/templates`\n\nList Extract Templates Public V2\n\n### Parameters\n\n- `limit?: number`\n\n- `offset?: number`\n\n### Returns\n\n- `{ items: { id: string; created_at: string; name: string; updated_at: string; published_version?: { id: string; created_at: string; input_schema: object; metadata: object; name: string; output_schema: object; version_number: number; samples?: object[]; }; published_version_id?: string; }[]; limit: number; offset: number; total: number; }`\n\n  - `items: { id: string; created_at: string; name: string; updated_at: string; published_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }; published_version_id?: string; }[]`\n  - `limit: number`\n  - `offset: number`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst templates = await client.extract.templates.list();\n\nconsole.log(templates);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.list',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst templates = await client.extract.templates.list();\n\nconsole.log(templates.items);",
      },
      python: {
        method: 'extract.templates.list',
        example:
          'import os\nfrom nimble_python import Nimble\n\nclient = Nimble(\n    api_key=os.environ.get("NIMBLE_API_KEY"),  # This is the default and can be omitted\n)\ntemplates = client.extract.templates.list()\nprint(templates.items)',
      },
      go: {
        method: 'client.Extract.Templates.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\ttemplates, err := client.Extract.Templates.List(context.TODO(), githubcomnimblewaynimblego.ExtractTemplateListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", templates.Items)\n}\n',
      },
      cli: {
        method: 'templates list',
        example: "nimble extract:templates list \\\n  --api-key 'My API Key'",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/templates \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    ...
    endpoint: '/v2/extract/templates/{extract_template_name}',
    httpMethod: 'patch',
    summary: 'Patch Extract Template Public V2',
    description: 'Patch Extract Template Public V2',
    stainlessPath: '(resource) extract.templates > (method) update',
    qualified: 'client.extract.templates.update',
    params: [
      'extract_template_name: string;',
      "body: { op: 'add' | 'remove' | 'replace' | 'move' | 'copy' | 'test'; path: string; from?: string; value?: object; }[];",
    ],
    response:
      '{ id: string; created_at: string; name: string; updated_at: string; published_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }; published_version_id?: string; }',
    markdown:
      "## update\n\n`client.extract.templates.update(extract_template_name: string, body: { op: 'add' | 'remove' | 'replace' | 'move' | 'copy' | 'test'; path: string; from?: string; value?: object; }[]): { id: string; created_at: string; name: string; updated_at: string; published_version?: object; published_version_id?: string; }`\n\n**patch** `/v2/extract/templates/{extract_template_name}`\n\nPatch Extract Template Public V2\n\n### Parameters\n\n- `extract_template_name: string`\n\n- `body: { op: 'add' | 'remove' | 'replace' | 'move' | 'copy' | 'test'; path: string; from?: string; value?: object; }[]`\n  A JSON Patch document per RFC 6902 — a JSON array of patch operations.\n\n### Returns\n\n- `{ id: string; created_at: string; name: string; updated_at: string; published_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }; published_version_id?: string; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `name: string`\n  - `updated_at: string`\n  - `published_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }`\n  - `published_version_id?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst template = await client.extract.templates.update('extract_template_name', { body: [{ op: 'add', path: 'path' }] });\n\nconsole.log(template);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.update',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst template = await client.extract.templates.update('extract_template_name', {\n  body: [{ op: 'add', path: 'path' }],\n});\n\nconsole.log(template.id);",
      },
      python: {
        method: 'extract.templates.update',
        example:
  ...
  },
  {
    ...
    endpoint: '/v2/extract/templates/{extract_template_name}',
    httpMethod: 'delete',
    summary: 'Delete Extract Template Public V2',
    description: 'Delete Extract Template Public V2',
    stainlessPath: '(resource) extract.templates > (method) delete',
    qualified: 'client.extract.templates.delete',
    params: ['extract_template_name: string;'],
    markdown:
      "## delete\n\n`client.extract.templates.delete(extract_template_name: string): void`\n\n**delete** `/v2/extract/templates/{extract_template_name}`\n\nDelete Extract Template Public V2\n\n### Parameters\n\n- `extract_template_name: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nawait client.extract.templates.delete('extract_template_name')\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.delete',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nawait client.extract.templates.delete('extract_template_name');",
      },
      python: {
        method: 'extract.templates.delete',
        example:
          'import os\nfrom nimble_python import Nimble\n\nclient = Nimble(\n    api_key=os.environ.get("NIMBLE_API_KEY"),  # This is the default and can be omitted\n)\nclient.extract.templates.delete(\n    "extract_template_name",\n)',
      },
      go: {
        method: 'client.Extract.Templates.Delete',
        example:
      ...
      cli: {
        ...
        example:
          "nimble extract:templates delete \\\n  --api-key 'My API Key' \\\n  --extract-template-name extract_template_name",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/templates/$EXTRACT_TEMPLATE_NAME \\\n    -X DELETE \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
  ...
  {
    name: 'create',
    endpoint: '/v2/extract/templates/generations',
    httpMethod: 'post',
    summary: 'Create Extract Template Generation Public V2',
    description: 'Create Extract Template Generation Public V2',
    stainlessPath: '(resource) extract.templates.generations > (method) create',
    qualified: 'client.extract.templates.generations.create',
    params: [
      '{ prompt: string; url: string; input_schema?: object; metadata?: { description?: string; display_name?: string; tags?: string[]; }; name?: string; output_schema?: object; } | { from_extract_template: string; prompt: string; };',
    ],
    response:
      '{ id: string; status: string; completed_at?: string; created_at?: string; error?: string; generated_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }; generated_version_id?: string; name?: string; source_version_id?: string; started_at?: string; summary?: string; }',
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.generations.create',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst generation = await client.extract.templates.generations.create({\n  prompt: 'prompt',\n  url: 'url',\n});\n\nconsole.log(generation.id);",
      },
      python: {
        method: 'extract.templates.generations.create',
        example:
          'from nimble_python import Nimble\n\nclient = Nimble()\ngeneration = client.extract.templates.generations.create(\n    prompt="prompt",\n    url="url",\n)\nprint(generation.id)',
      },
      go: {
        method: 'client.Extract.Templates.Generations.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient()\n\tgeneration, err := client.Extract.Templates.Generations.New(context.TODO(), githubcomnimblewaynimblego.ExtractTemplateGenerationNewParams{\n\t\tOfCreateExtractTemplateGenerationRequestPublicV2: &githubcomnimblewaynimblego.ExtractTemplateGenerationNewParamsBodyCreateExtractTemplateGenerationRequestPublicV2{\n\t\t\tPrompt: "prompt",\n\t\t\tURL:    "url",\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", generation.ID)\n}\n',
      },
      cli: {
        method: 'generations create',
        example:
          'nimble extract:templates:generations create \\\n  --prompt prompt \\\n  --url url \\\n  --from-extract-template from_extract_template',
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/templates/generations \\\n    -H \'Content-Type: application/json\' \\\n    -d \'{\n          "prompt": "prompt",\n          "url": "url"\n        }\'',
      },
    },
  },
  {
    name: 'get',
    endpoint: '/v2/extract/templates/generations/{generation_id}',
    httpMethod: 'get',
    summary: 'Get Extract Template Generation Public V2',
    description: 'Get Extract Template Generation Public V2',
    stainlessPath: '(resource) extract.templates.generations > (method) get',
    qualified: 'client.extract.templates.generations.get',
    params: ['generation_id: string;'],
    response:
      '{ id: string; status: string; completed_at?: string; created_at?: string; error?: string; generated_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }; generated_version_id?: string; name?: string; source_version_id?: string; started_at?: string; summary?: string; }',
    markdown:
      "## get\n\n`client.extract.templates.generations.get(generation_id: string): { id: string; status: string; completed_at?: string; created_at?: string; error?: string; generated_version?: object; generated_version_id?: string; name?: string; source_version_id?: string; started_at?: string; summary?: string; }`\n\n**get** `/v2/extract/templates/generations/{generation_id}`\n\nGet Extract Template Generation Public V2\n\n### Parameters\n\n- `generation_id: string`\n\n### Returns\n\n- `{ id: string; status: string; completed_at?: string; created_at?: string; error?: string; generated_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }; generated_version_id?: string; name?: string; source_version_id?: string; started_at?: string; summary?: string; }`\n\n  - `id: string`\n  - `status: string`\n  - `completed_at?: string`\n  - `created_at?: string`\n  - `error?: string`\n  - `generated_version?: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }`\n  - `generated_version_id?: string`\n  - `name?: string`\n  - `source_version_id?: string`\n  - `started_at?: string`\n  - `summary?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst generation = await client.extract.templates.generations.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(generation);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.generations.get',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst generation = await client.extract.templates.generations.get(\n  '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n);\n\nconsole.log(generation.id);",
      },
      python: {
        method: 'extract.templates.generations.get',
        example:
      ...
      go: {
        method: 'client.Extract.Templates.Generations.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tgeneration, err := client.Extract.Templates.Generations.Get(context.TODO(), "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", generation.ID)\n}\n',
      },
      cli: {
        method: 'generations get',
        example:
          "nimble extract:templates:generations get \\\n  --api-key 'My API Key' \\\n  --generation-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/templates/generations/$GENERATION_ID \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    name: 'list',
    endpoint: '/v2/extract/templates/{extract_template_name}/versions',
    httpMethod: 'get',
    summary: 'List Extract Template Versions Public V2',
    description: 'List Extract Template Versions Public V2',
    stainlessPath: '(resource) extract.templates.versions > (method) list',
    qualified: 'client.extract.templates.versions.list',
    params: ['extract_template_name: string;', 'limit?: number;', 'offset?: number;'],
    response:
      '{ items: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }[]; limit: number; offset: number; total: number; }',
    markdown:
      "## list\n\n`client.extract.templates.versions.list(extract_template_name: string, limit?: number, offset?: number): { items: object[]; limit: number; offset: number; total: number; }`\n\n**get** `/v2/extract/templates/{extract_template_name}/versions`\n\nList Extract Template Versions Public V2\n\n### Parameters\n\n- `extract_template_name: string`\n\n- `limit?: number`\n\n- `offset?: number`\n\n### Returns\n\n- `{ items: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }[]; limit: number; offset: number; total: number; }`\n\n  - `items: { id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }[]`\n  - `limit: number`\n  - `offset: number`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst versions = await client.extract.templates.versions.list('extract_template_name');\n\nconsole.log(versions);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.versions.list',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst versions = await client.extract.templates.versions.list('extract_template_name');\n\nconsole.log(versions.items);",
      },
      python: {
        method: 'extract.templates.versions.list',
        example:
          'import os\nfrom nimble_python import Nimble\n\nclient = Nimble(\n    api_key=os.environ.get("NIMBLE_API_KEY"),  # This is the default and can be omitted\n)\nversions = client.extract.templates.versions.list(\n    extract_template_name="extract_template_name",\n)\nprint(versions.items)',
      },
      go: {
        method: 'client.Extract.Templates.Versions.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tversions, err := client.Extract.Templates.Versions.List(\n\t\tcontext.TODO(),\n\t\t"extract_template_name",\n\t\tgithubcomnimblewaynimblego.ExtractTemplateVersionListParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", versions.Items)\n}\n',
      },
      cli: {
        method: 'versions list',
        example:
          "nimble extract:templates:versions list \\\n  --api-key 'My API Key' \\\n  --extract-template-name extract_template_name",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/templates/$EXTRACT_TEMPLATE_NAME/versions \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    name: 'get',
    endpoint: '/v2/extract/templates/{extract_template_name}/versions/{version_id}',
    httpMethod: 'get',
    summary: 'Get Extract Template Version Public V2',
    description: 'Get Extract Template Version Public V2',
    stainlessPath: '(resource) extract.templates.versions > (method) get',
    qualified: 'client.extract.templates.versions.get',
    params: ['extract_template_name: string;', 'version_id: string;'],
    response:
      '{ id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }',
    markdown:
      "## get\n\n`client.extract.templates.versions.get(extract_template_name: string, version_id: string): { id: string; created_at: string; input_schema: object; metadata: object; name: string; output_schema: object; version_number: number; samples?: object[]; }`\n\n**get** `/v2/extract/templates/{extract_template_name}/versions/{version_id}`\n\nGet Extract Template Version Public V2\n\n### Parameters\n\n- `extract_template_name: string`\n\n- `version_id: string`\n\n### Returns\n\n- `{ id: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; name: string; output_schema: object; version_number: number; samples?: { input?: object; output?: object; }[]; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `input_schema: object`\n  - `metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }`\n  - `name: string`\n  - `output_schema: object`\n  - `version_number: number`\n  - `samples?: { input?: object; output?: object; }[]`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst version = await client.extract.templates.versions.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { extract_template_name: 'extract_template_name' });\n\nconsole.log(version);\n```",
    perLanguage: {
      typescript: {
        method: 'client.extract.templates.versions.get',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst version = await client.extract.templates.versions.get(\n  '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n  { extract_template_name: 'extract_template_name' },\n);\n\nconsole.log(version.id);",
      },
      python: {
        method: 'extract.templates.versions.get',
        example:
      ...
      go: {
        method: 'client.Extract.Templates.Versions.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tversion, err := client.Extract.Templates.Versions.Get(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tgithubcomnimblewaynimblego.ExtractTemplateVersionGetParams{\n\t\t\tExtractTemplateName: "extract_template_name",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", version.ID)\n}\n',
      },
      cli: {
        method: 'versions get',
        example:
          "nimble extract:templates:versions get \\\n  --api-key 'My API Key' \\\n  --extract-template-name extract_template_name \\\n  --version-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/extract/templates/$EXTRACT_TEMPLATE_NAME/versions/$VERSION_ID \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    ...
    params: ['limit?: number;', 'offset?: number;'],
    response:
      "{ items: { id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: { allow?: object[]; avoid?: string; block?: object[]; prioritize?: string; }; suggested_questions: { id: string; order: number; question: string; }[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }[]; limit: number; offset: number; total: number; }",
    markdown:
      "## list\n\n`client.agents.list(limit?: number, offset?: number): { items: object[]; limit: number; offset: number; total: number; }`\n\n**get** `/v2/agents`\n\nList the active Web Search Agents in your account. Results are scoped to the workspace resolved from your token (or the optional `workspace_id` query parameter) and paginated with `offset`/`limit`.\n\n### Parameters\n\n- `limit?: number`\n\n- `offset?: number`\n\n### Returns\n\n- `{ items: { id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: { allow?: object[]; avoid?: string; block?: object[]; prioritize?: string; }; suggested_questions: { id: string; order: number; question: string; }[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }[]; limit: number; offset: number; total: number; }`\n\n  - `items: { id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: { allow?: { id: string; domains: string[]; order: number; title: string; }[]; avoid?: string; block?: { id: string; domains: string[]; order: number; title: string; }[]; prioritize?: string; }; suggested_questions: { id: string; order: number; question: string; }[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }[]`\n  - `limit: number`\n  - `offset: number`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst agents = await client.agents.list();\n\nconsole.log(agents);\n```",
    perLanguage: {
      typescript: {
      ...
      go: {
        method: 'client.Agents.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient()\n\tagents, err := client.Agents.List(context.TODO(), githubcomnimblewaynimblego.AgentListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", agents.Items)\n}\n',
      },
      cli: {
        method: 'agents list',
        example: 'nimble agents list',
      },
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/agents',
      },
    },
  },
  {
    ...
    response:
      "{ id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: { allow?: { id: string; domains: string[]; order: number; title: string; }[]; avoid?: string; block?: { id: string; domains: string[]; order: number; title: string; }[]; prioritize?: string; }; suggested_questions: { id: string; order: number; question: string; }[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }",
    markdown:
      "## create\n\n`client.agents.create(agent_name?: string, description?: string, display_name?: string, effort?: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max', goals?: string[], icon?: string, is_active?: boolean, output_schema?: object, skill?: string, sources?: { allow?: { domains: string[]; title: string; order?: number; }[]; avoid?: string; block?: { domains: string[]; title: string; order?: number; }[]; prioritize?: string; }, suggested_questions?: string[], template?: string, use_case?: 'research' | 'enrichment' | 'dataset_building'): { id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: object[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: object; suggested_questions: object[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }`\n\n**post** `/v2/agents`\n\nCreate a Web Search Agent. Either pass `template` to materialize a pre-built template (its fields, goals, sources, and suggested questions are copied), or define the agent from scratch with `display_name`, `goals`, `sources`, and an optional `output_schema` for structured results.\n\n### Parameters\n\n- `agent_name?: string`\n  Stable agent name.\n\n- `description?: string`\n  Agent description shown to users.\n\n- `display_name?: string`\n  Human-friendly agent name shown to users.\n\n- `effort?: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'`\n  Default effort level for this agent's runs.\n\n- `goals?: string[]`\n  Ordered goals for the agent to follow.\n\n- `icon?: string`\n  Icon identifier used when presenting the agent.\n\n- `is_active?: boolean`\n  Whether the agent can be used to start new runs.\n\n- `output_schema?: object`\n  JSON schema describing the structured output the agent should produce.\n\n- `skill?: string`\n  Skill or operating context for the agent.\n\n- `sources?: { allow?: { domains: string[]; title: string; order?: number; }[]; avoid?: string; block?: { domains: string[]; title: string; order?: number; }[]; prioritize?: string; }`\n  Source guidance for the agent.\n  - `allow?: { domains: string[]; title: string; order?: number; }[]`\n    Source groups the agent is allowed to use.\n  - `avoid?: string`\n    Free-text guidance describing sources or domains to avoid.\n  - `block?: { domains: string[]; title: string; order?: number; }[]`\n    Source groups the agent should not use.\n  - `prioritize?: string`\n    Free-text guidance describing sources or domains to prioritize.\n\n- `suggested_questions?: string[]`\n  Suggested prompts users can run with this agent.\n\n- `template?: string`\n  Template name to materialize this instance from. When set, the scalar fields and child rows are copied from the template.\n\n- `use_case?: 'research' | 'enrichment' | 'dataset_building'`\n  Primary use case supported by the agent.\n\n### Returns\n\n- `{ id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: { allow?: { id: string; domains: string[]; order: number; title: string; }[]; avoid?: string; block?: { id: string; domains: string[]; order: number; title: string; }[]; prioritize?: string; }; suggested_questions: { id: string; order: number; question: string; }[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `description: string`\n  - `display_name: string`\n  - `effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'`\n  - `goals: { id: string; goal: string; order: number; }[]`\n  - `icon: string`\n  - `is_active: boolean`\n  - `output_schema: object`\n  - `skill: string`\n  - `sources: { allow?: { id: string; domains: string[]; order: number; title: string; }[]; avoid?: string; block?: { id: string; domains: string[]; order: number; title: string; }[]; prioritize?: string; }`\n  - `suggested_questions: { id: string; order: number; question: string; }[]`\n  - `updated_at: string`\n  - `use_case: 'research' | 'enrichment' | 'dataset_building'`\n  - `agent_name?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst agent = await client.agents.create();\n\nconsole.log(agent);\n```",
    perLanguage: {
      typescript: {
      ...
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tagent, err := client.Agents.New(context.TODO(), githubcomnimblewaynimblego.AgentNewParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", agent.ID)\n}\n',
      },
      cli: {
        method: 'agents create',
        example: "nimble agents create \\\n  --api-key 'My API Key'",
      },
      http: {
        example:
          "curl https://sdk.nimbleway.com/v2/agents \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\" \\\n    -d '{}'",
      },
    },
  },
  {
    name: 'delete',
    endpoint: '/v2/agents/{agent_id}',
    httpMethod: 'delete',
    ...
    perLanguage: {
      ...
      cli: {
        method: 'agents delete',
        example:
          "nimble agents delete \\\n  --api-key 'My API Key' \\\n  --agent-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/agents/$AGENT_ID \\\n    -X DELETE \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    ...
    stainlessPath: '(resource) agents > (method) get',
    qualified: 'client.agents.get',
    params: ['agent_id: string;'],
    response:
      "{ id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: { allow?: { id: string; domains: string[]; order: number; title: string; }[]; avoid?: string; block?: { id: string; domains: string[]; order: number; title: string; }[]; prioritize?: string; }; suggested_questions: { id: string; order: number; question: string; }[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }",
    markdown:
      "## get\n\n`client.agents.get(agent_id: string): { id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: object[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: object; suggested_questions: object[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }`\n\n**get** `/v2/agents/{agent_id}`\n\nRetrieve a single Web Search Agent by ID.\n\n### Parameters\n\n- `agent_id: string`\n\n### Returns\n\n- `{ id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: { allow?: { id: string; domains: string[]; order: number; title: string; }[]; avoid?: string; block?: { id: string; domains: string[]; order: number; title: string; }[]; prioritize?: string; }; suggested_questions: { id: string; order: number; question: string; }[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `description: string`\n  - `display_name: string`\n  - `effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'`\n  - `goals: { id: string; goal: string; order: number; }[]`\n  - `icon: string`\n  - `is_active: boolean`\n  - `output_schema: object`\n  - `skill: string`\n  - `sources: { allow?: { id: string; domains: string[]; order: number; title: string; }[]; avoid?: string; block?: { id: string; domains: string[]; order: number; title: string; }[]; prioritize?: string; }`\n  - `suggested_questions: { id: string; order: number; question: string; }[]`\n  - `updated_at: string`\n  - `use_case: 'research' | 'enrichment' | 'dataset_building'`\n  - `agent_name?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst agent = await client.agents.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(agent);\n```",
    perLanguage: {
      typescript: {
      ...
      go: {
        method: 'client.Agents.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient()\n\tagent, err := client.Agents.Get(context.TODO(), "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", agent.ID)\n}\n',
      },
      cli: {
        method: 'agents get',
        example: 'nimble agents get \\\n  --agent-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      },
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/agents/$AGENT_ID',
      },
    },
  },
  {
    ...
    description:
      'Update an agent with a [JSON Patch](https://datatracker.ietf.org/doc/html/rfc6902) document — an array of `{op, path, value}` operations applied to the agent, e.g. `[{"op": "replace", "path": "/display_name", "value": "My agent"}]`. Returns the updated agent.',
    ...
    response:
      "{ id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: { allow?: { id: string; domains: string[]; order: number; title: string; }[]; avoid?: string; block?: { id: string; domains: string[]; order: number; title: string; }[]; prioritize?: string; }; suggested_questions: { id: string; order: number; question: string; }[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }",
    markdown:
      "## update\n\n`client.agents.update(agent_id: string, body: { op: 'add' | 'remove' | 'replace' | 'move' | 'copy' | 'test'; path: string; from?: string; value?: object; }[]): { id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: object[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: object; suggested_questions: object[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }`\n\n**patch** `/v2/agents/{agent_id}`\n\nUpdate an agent with a [JSON Patch](https://datatracker.ietf.org/doc/html/rfc6902) document — an array of `{op, path, value}` operations applied to the agent, e.g. `[{\"op\": \"replace\", \"path\": \"/display_name\", \"value\": \"My agent\"}]`. Returns the updated agent.\n\n### Parameters\n\n- `agent_id: string`\n\n- `body: { op: 'add' | 'remove' | 'replace' | 'move' | 'copy' | 'test'; path: string; from?: string; value?: object; }[]`\n  A JSON Patch document per RFC 6902 — a JSON array of patch operations.\n\n### Returns\n\n- `{ id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; is_active: boolean; output_schema: object; skill: string; sources: { allow?: { id: string; domains: string[]; order: number; title: string; }[]; avoid?: string; block?: { id: string; domains: string[]; order: number; title: string; }[]; prioritize?: string; }; suggested_questions: { id: string; order: number; question: string; }[]; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; agent_name?: string; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `description: string`\n  - `display_name: string`\n  - `effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'`\n  - `goals: { id: string; goal: string; order: number; }[]`\n  - `icon: string`\n  - `is_active: boolean`\n  - `output_schema: object`\n  - `skill: string`\n  - `sources: { allow?: { id: string; domains: string[]; order: number; title: string; }[]; avoid?: string; block?: { id: string; domains: string[]; order: number; title: string; }[]; prioritize?: string; }`\n  - `suggested_questions: { id: string; order: number; question: string; }[]`\n  - `updated_at: string`\n  - `use_case: 'research' | 'enrichment' | 'dataset_building'`\n  - `agent_name?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst agent = await client.agents.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { body: [{ op: 'add', path: 'path' }] });\n\nconsole.log(agent);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    stainlessPath: '(resource) agents.templates > (method) list',
    qualified: 'client.agents.templates.list',
    params: ['limit?: number;', 'offset?: number;'],
    response:
      "{ items: { id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; output_schema: object; skill: string; sources: { id: string; domains: string[]; order: number; title: string; }[]; suggested_questions: { id: string; order: number; question: string; }[]; template_name: string; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; }[]; limit: number; offset: number; total: number; }",
    markdown:
      "## list\n\n`client.agents.templates.list(limit?: number, offset?: number): { items: object[]; limit: number; offset: number; total: number; }`\n\n**get** `/v2/agents/templates`\n\nList the pre-built agent templates available to your account. Use a template's `template_name` with `POST /v2/agents` to create an agent instance from it.\n\n### Parameters\n\n- `limit?: number`\n\n- `offset?: number`\n\n### Returns\n\n- `{ items: { id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; output_schema: object; skill: string; sources: { id: string; domains: string[]; order: number; title: string; }[]; suggested_questions: { id: string; order: number; question: string; }[]; template_name: string; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; }[]; limit: number; offset: number; total: number; }`\n\n  - `items: { id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; output_schema: object; skill: string; sources: { id: string; domains: string[]; order: number; title: string; }[]; suggested_questions: { id: string; order: number; question: string; }[]; template_name: string; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; }[]`\n  - `limit: number`\n  - `offset: number`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst templates = await client.agents.templates.list();\n\nconsole.log(templates);\n```",
    perLanguage: {
      typescript: {
        method: 'client.agents.templates.list',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst templates = await client.agents.templates.list();\n\nconsole.log(templates.items);",
      },
      python: {
        ...
        example:
          'from nimble_python import Nimble\n\nclient = Nimble()\ntemplates = client.agents.templates.list()\nprint(templates.items)',
      },
      go: {
        method: 'client.Agents.Templates.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient()\n\ttemplates, err := client.Agents.Templates.List(context.TODO(), githubcomnimblewaynimblego.AgentTemplateListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", templates.Items)\n}\n',
      },
      cli: {
        method: 'templates list',
        example: 'nimble agents:templates list',
      },
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/agents/templates',
      },
    },
  },
  {
    name: 'get',
    endpoint: '/v2/agents/templates/{template_name}',
    httpMethod: 'get',
    summary: 'Get Agent Template',
    description: 'Retrieve a single agent template by its stable `template_name`.',
    stainlessPath: '(resource) agents.templates > (method) get',
    qualified: 'client.agents.templates.get',
    params: ['template_name: string;'],
    response:
      "{ id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; output_schema: object; skill: string; sources: { id: string; domains: string[]; order: number; title: string; }[]; suggested_questions: { id: string; order: number; question: string; }[]; template_name: string; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; }",
    markdown:
      "## get\n\n`client.agents.templates.get(template_name: string): { id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: object[]; icon: string; output_schema: object; skill: string; sources: object[]; suggested_questions: object[]; template_name: string; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; }`\n\n**get** `/v2/agents/templates/{template_name}`\n\nRetrieve a single agent template by its stable `template_name`.\n\n### Parameters\n\n- `template_name: string`\n\n### Returns\n\n- `{ id: string; created_at: string; description: string; display_name: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; goals: { id: string; goal: string; order: number; }[]; icon: string; output_schema: object; skill: string; sources: { id: string; domains: string[]; order: number; title: string; }[]; suggested_questions: { id: string; order: number; question: string; }[]; template_name: string; updated_at: string; use_case: 'research' | 'enrichment' | 'dataset_building'; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `description: string`\n  - `display_name: string`\n  - `effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'`\n  - `goals: { id: string; goal: string; order: number; }[]`\n  - `icon: string`\n  - `output_schema: object`\n  - `skill: string`\n  - `sources: { id: string; domains: string[]; order: number; title: string; }[]`\n  - `suggested_questions: { id: string; order: number; question: string; }[]`\n  - `template_name: string`\n  - `updated_at: string`\n  - `use_case: 'research' | 'enrichment' | 'dataset_building'`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst template = await client.agents.templates.get('template_name');\n\nconsole.log(template);\n```",
    perLanguage: {
      typescript: {
        method: 'client.agents.templates.get',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst template = await client.agents.templates.get('template_name');\n\nconsole.log(template.id);",
      },
      python: {
        method: 'agents.templates.get',
        example:
      ...
      go: {
        method: 'client.Agents.Templates.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient()\n\ttemplate, err := client.Agents.Templates.Get(context.TODO(), "template_name")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", template.ID)\n}\n',
      },
      cli: {
        method: 'templates get',
        example: 'nimble agents:templates get \\\n  --template-name template_name',
      },
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/agents/templates/$TEMPLATE_NAME',
      },
    },
  },
  {
    name: 'create',
    endpoint: '/v2/agents/{agent_id}/runs',
    httpMethod: 'post',
    ...
    response:
      "{ id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }",
    markdown:
      "## create\n\n`client.agents.runs.create(agent_id: string, input: string, agent_name?: string, effort?: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max', enable_events?: boolean, input_data?: object[] | object, origin?: 'api', output_schema?: object, previous_interaction_id?: string, skill?: string, sources?: { allow?: { domains: string[]; title: string; order?: number; }[]; avoid?: string; block?: { domains: string[]; title: string; order?: number; }[]; prioritize?: string; }, use_case?: 'research' | 'enrichment' | 'dataset_building'): { id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: object; prompt?: string; started_at?: string; }`\n\n**post** `/v2/agents/{agent_id}/runs`\n\nStart an agent run. The run executes asynchronously: the response returns immediately with status `queued`, then poll `GET .../runs/{run_id}` until `completed` and fetch the output from `GET .../runs/{run_id}/result` — or set `enable_events: true` and follow `GET .../runs/{run_id}/events` for live progress.\n\nTo enrich existing records instead of researching from scratch, pass them in `input_data`; this requires an `output_schema` (on the request or the agent).\n\n### Parameters\n\n- `agent_id: string`\n\n- `input: string`\n  User prompt or task instructions for the run.\n\n- `agent_name?: string`\n  Stable agent name. On this no-agent-id route, an unseen name creates a new agent; an existing name reuses it. Ignored on the /{agent_id}/runs route.\n\n- `effort?: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'`\n  Canonical effort tier names for the research graph.\n\n- `enable_events?: boolean`\n  Whether to stream run events when supported.\n\n- `input_data?: object[] | object`\n  Existing records to ENRICH: a list of partial rows, or a single object, mirroring output_schema's shape.\n\n- `origin?: 'api'`\n  Origin of public API runs. Public requests are always API-originated.\n\n- `output_schema?: object`\n  JSON schema overriding the agent's default structured output for this run.\n\n- `previous_interaction_id?: string`\n  Previous interaction identifier used to continue a conversation.\n\n- `skill?: string`\n  Skill override for this run. One-time only, except when this run creates a new agent via agent_name, in which case it becomes the new agent's stored skill.\n\n- `sources?: { allow?: { domains: string[]; title: string; order?: number; }[]; avoid?: string; block?: { domains: string[]; title: string; order?: number; }[]; prioritize?: string; }`\n  Source guidance overriding the agent default.\n  - `allow?: { domains: string[]; title: string; order?: number; }[]`\n    Source groups the agent is allowed to use.\n  - `avoid?: string`\n    Free-text guidance describing sources or domains to avoid.\n  - `block?: { domains: string[]; title: string; order?: number; }[]`\n    Source groups the agent should not use.\n  - `prioritize?: string`\n    Free-text guidance describing sources or domains to prioritize.\n\n- `use_case?: 'research' | 'enrichment' | 'dataset_building'`\n  Only settable when this run creates a new agent (via agent_name, or when no agent is resolved), in which case it becomes the new agent's stored use_case. For a run against an existing agent, this must match the agent's own use_case — passing the same value is accepted as a no-op, a different value is rejected.\n\n### Returns\n\n- `{ id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'`\n  - `interaction_id: string`\n  - `is_active: boolean`\n  - `status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'`\n  - `web_search_agent_id: string`\n  - `completed_at?: string`\n  - `error?: { message: string; ref_id: string; }`\n  - `prompt?: string`\n  - `started_at?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst run = await client.agents.runs.create('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { input: 'input' });\n\nconsole.log(run);\n```",
    perLanguage: {
      typescript: {
      ...
      go: {
        method: 'client.Agents.Runs.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient()\n\trun, err := client.Agents.Runs.New(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tgithubcomnimblewaynimblego.AgentRunNewParams{\n\t\t\tInput: "input",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", run.ID)\n}\n',
      },
      cli: {
        method: 'runs create',
        example:
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/agents/$AGENT_ID/runs \\\n    -H \'Content-Type: application/json\' \\\n    -d \'{\n          "input": "input"\n        }\'',
      },
    },
  },
  {
    ...
    stainlessPath: '(resource) agents.runs > (method) list',
    qualified: 'client.agents.runs.list',
    params: ['agent_id: string;', 'limit?: number;', 'offset?: number;'],
    response:
      "{ items: { id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }[]; limit: number; offset: number; total: number; }",
    markdown:
      "## list\n\n`client.agents.runs.list(agent_id: string, limit?: number, offset?: number): { items: object[]; limit: number; offset: number; total: number; }`\n\n**get** `/v2/agents/{agent_id}/runs`\n\nList the runs of an agent, newest first, paginated with `offset`/`limit`.\n\n### Parameters\n\n- `agent_id: string`\n\n- `limit?: number`\n\n- `offset?: number`\n\n### Returns\n\n- `{ items: { id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }[]; limit: number; offset: number; total: number; }`\n\n  - `items: { id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }[]`\n  - `limit: number`\n  - `offset: number`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst runs = await client.agents.runs.list('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(runs);\n```",
    perLanguage: {
      typescript: {
        method: 'client.agents.runs.list',
        example:
      ...
      python: {
        ...
        example:
          'import os\nfrom nimble_python import Nimble\n\nclient = Nimble(\n    api_key=os.environ.get("NIMBLE_API_KEY"),  # This is the default and can be omitted\n)\nruns = client.agents.runs.list(\n    agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n)\nprint(runs.items)',
      },
      go: {
        method: 'client.Agents.Runs.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\truns, err := client.Agents.Runs.List(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tgithubcomnimblewaynimblego.AgentRunListParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", runs.Items)\n}\n',
      },
      cli: {
        method: 'runs list',
        example:
          "nimble agents:runs list \\\n  --api-key 'My API Key' \\\n  --agent-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/agents/$AGENT_ID/runs \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
  ...
  {
    name: 'get',
    endpoint: '/v2/agents/{agent_id}/runs/{run_id}',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) agents.runs > (method) get',
    qualified: 'client.agents.runs.get',
    params: ['agent_id: string;', 'run_id: string;'],
    response:
      "{ id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }",
    markdown:
      "## get\n\n`client.agents.runs.get(agent_id: string, run_id: string): { id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: object; prompt?: string; started_at?: string; }`\n\n**get** `/v2/agents/{agent_id}/runs/{run_id}`\n\nRetrieve a run's current state. Poll this endpoint after creating a run: the run is finished once `status` is `completed`, `failed`, or `cancelled`.\n\n### Parameters\n\n- `agent_id: string`\n\n- `run_id: string`\n\n### Returns\n\n- `{ id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'`\n  - `interaction_id: string`\n  - `is_active: boolean`\n  - `status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'`\n  - `web_search_agent_id: string`\n  - `completed_at?: string`\n  - `error?: { message: string; ref_id: string; }`\n  - `prompt?: string`\n  - `started_at?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst run = await client.agents.runs.get('run_id', { agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });\n\nconsole.log(run);\n```",
    perLanguage: {
      typescript: {
        method: 'client.agents.runs.get',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst run = await client.agents.runs.get('run_id', {\n  agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n});\n\nconsole.log(run.id);",
      },
      python: {
  ...
  {
    name: 'stream_events',
    endpoint: '/v2/agents/{agent_id}/runs/{run_id}/events',
    httpMethod: 'get',
    ...
    perLanguage: {
      ...
      cli: {
        ...
        example:
          "nimble agents:runs stream-events \\\n  --api-key 'My API Key' \\\n  --agent-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --run-id run_id",
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/agents/$AGENT_ID/runs/$RUN_ID/events \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    name: 'result',
    endpoint: '/v2/agents/{agent_id}/runs/{run_id}/result',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) agents.runs > (method) result',
    qualified: 'client.agents.runs.result',
    params: ['agent_id: string;', 'run_id: string;'],
    response:
      "{ output: { content: string; trust: { claims: object[]; confidence: 'high' | 'medium' | 'low' | 'pre_existing'; reasoning: string; sources: object[]; }; type?: 'text'; } | { content: object | object[]; trust: { claims: object[]; confidence: 'high' | 'medium' | 'low' | 'pre_existing'; reasoning: string; sources: object[]; }; type?: 'json'; }; run: { id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }; } | { error: { message: string; ref_id: string; }; run: { id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }; }",
    markdown:
      "## result\n\n`client.agents.runs.result(agent_id: string, run_id: string): { output: object | object; run: object; } | { error: object; run: object; }`\n\n**get** `/v2/agents/{agent_id}/runs/{run_id}/result`\n\nFetch the output of a completed run. The `output` is `type: \"text\"` (a prose answer) or `type: \"json\"` (structured data matching the output schema), plus `trust` metadata with per-claim citations for the answer.\n\nWhile the run is still `queued` or `running` this endpoint returns `409`; if the run `failed` or was `cancelled` it returns `422` with the run and error details.\n\n### Parameters\n\n- `agent_id: string`\n\n- `run_id: string`\n\n### Returns\n\n- `{ output: { content: string; trust: { claims: object[]; confidence: 'high' | 'medium' | 'low' | 'pre_existing'; reasoning: string; sources: object[]; }; type?: 'text'; } | { content: object | object[]; trust: { claims: object[]; confidence: 'high' | 'medium' | 'low' | 'pre_existing'; reasoning: string; sources: object[]; }; type?: 'json'; }; run: { id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }; } | { error: { message: string; ref_id: string; }; run: { id: string; created_at: string; effort: 'low' | 'medium' | 'high' | 'x-high' | '5x-high' | 'max'; interaction_id: string; is_active: boolean; status: 'queued' | 'running' | 'completed' | 'failed' | 'cancelled'; web_search_agent_id: string; completed_at?: string; error?: { message: string; ref_id: string; }; prompt?: string; started_at?: string; }; }`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.agents.runs.result('run_id', { agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.agents.runs.result',
        example:
          "import Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble({\n  apiKey: process.env['NIMBLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.agents.runs.result('run_id', {\n  agent_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n});\n\nconsole.log(response);",
      },
      python: {
        method: 'agents.runs.result',
        example:
          'import os\nfrom nimble_python import Nimble\n\nclient = Nimble(\n    api_key=os.environ.get("NIMBLE_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.agents.runs.result(\n    run_id="run_id",\n    agent_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n)\nprint(response)',
      },
      go: {
        method: 'client.Agents.Runs.Result',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/Nimbleway/nimble-go"\n\t"github.com/Nimbleway/nimble-go/option"\n)\n\nfunc main() {\n\tclient := githubcomnimblewaynimblego.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Agents.Runs.Result(\n\t\tcontext.TODO(),\n\t\t"run_id",\n\t\tgithubcomnimblewaynimblego.AgentRunResultParams{\n\t\t\tAgentID: "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      cli: {
        method: 'runs result',
        example:
          "nimble agents:runs result \\\n  --api-key 'My API Key' \\\n  --agent-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --run-id run_id",
      },
      http: {
        example:
  ...
  },
  {
    ...
    params: [
      ...
      "extract_options?: { auto_driver_configuration?: object; body?: object; browser?: 'chrome' | 'firefox' | { name: 'chrome' | 'firefox'; version?: string; }; browser_actions?: { auto_scroll: boolean | number | string | { click_selector?: string | string[]; container?: string | string[]; delay_after_scroll?: number | string; idle_timeout?: number | string; loading_selector?: string | string[]; max_duration?: number | string; pause_on_selector?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; step_size?: number; }; } | { click: string | string[] | { selector: string | string[]; count?: number; delay?: number | string; offset_x?: number; offset_y?: number; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; steps?: number; strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; timeout?: number; visible?: boolean; }; } | { eval: string | { code: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fetch: string | { url: string; body?: string; headers?: object; method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; } | { fill: { selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; mode?: 'type'; mouse_movement_strategy?: 'linear' | 'ghost-cursor' | 'windmouse'; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; typing_interval?: number | string; typing_strategy?: 'simple' | 'distribution'; visible?: boolean; } | { mode: 'paste'; selector: string | string[]; value: string; click_on_element?: boolean; delay?: number | string; required?: 'true' | 'false' | boolean; scroll?: boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { get_cookies: boolean | { required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { goto: string | { url: string; referer?: string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; wait_until?: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; }; } | { press: string | { key: string; delay?: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { screenshot: boolean | { format?: 'png' | 'jpeg' | 'webp'; full_page?: boolean; quality?: number; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { scroll: number | string | { container?: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; to?: string | string[]; visible?: boolean; x?: number; y?: number; }; } | { wait: number | string | { duration: number | string; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; }; } | { wait_for_element: string | string[] | { selector: string | string[]; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; visible?: boolean; }; } | { wait_for_navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2' | { navigation: 'load' | 'domcontentloaded' | 'networkidle0' | 'networkidle2'; required?: 'true' | 'false' | boolean; skip?: 'true' | 'false' | boolean; timeout?: number; }; }[]; city?: string; consent_header?: boolean; cookies?: { creation?: string; domain?: string; expires?: string; extensions?: string[]; hostOnly?: boolean; httpOnly?: boolean; lastAccessed?: string; maxAge?: 'Infinity' | '-Infinity' | number; name?: string; path?: string; pathIsDefault?: boolean; sameSite?: 'strict' | 'lax' | 'none'; secure?: boolean; value?: string; }[] | string; country?: string; device?: 'desktop' | 'mobile' | 'tablet'; driver?: string; expected_status_codes?: number[]; formats?: 'html' | 'markdown' | 'screenshot' | 'headers' | 'links'[]; headers?: object; http2?: boolean; is_xhr?: boolean; locale?: string; markdown_backend?: 'full_page' | 'main_content'; method?: 'GET' | 'POST' | 'PUT' | 'PATCH' | 'DELETE'; network_capture?: { method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { value: string; type?: 'exact' | 'contains'; }; validation?: boolean; wait_for_requests_count?: number; wait_for_requests_count_timeout?: number; }[]; os?: 'windows' | 'mac os' | 'linux' | 'android' | 'ios'; parse?: boolean; parser?: object | string; realtime_total_timeout?: number; referrer_type?: 'random' | 'no-referer' | 'same-origin' | 'google' | 'bing' | 'facebook' | 'twitter' | 'instagram'; render?: boolean | 'auto'; request_timeout?: number; session?: { id?: string; prefetch_userbrowser?: boolean; renew_on_blocked?: boolean; retry?: boolean; timeout?: number; }; skill?: string | string[]; state?: string; tag?: string; url?: string; };",
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/crawl \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "url": "url",\n          "allow_external_links": false,\n          "allow_subdomains": false,\n          "crawl_entire_domain": false,\n          "exclude_paths": [\n            "/exclude-this-path",\n            "/and-this-path"\n          ],\n          "ignore_query_parameters": false,\n          "include_paths": [\n            "/include-this-path",\n            "/and-this-path"\n          ],\n          "limit": 100,\n          "max_discovery_depth": 3,\n          "name": "The best crawl ever",\n          "sitemap": "include"\n        }\'',
      },
    },
  },
  {
    name: 'status',
    endpoint: '/v2/crawl/{id}',
    httpMethod: 'get',
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/crawl/$ID \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/crawl \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    response:
      "{ data: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]; pagination: { has_next: boolean; next_cursor: string; total: number; }; }",
    markdown:
    ...
    perLanguage: {
      ...
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/tasks \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    name: 'get',
    endpoint: '/v2/tasks/{task_id}',
    httpMethod: 'get',
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/tasks/$TASK_ID \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    name: 'results',
    endpoint: '/v2/tasks/{task_id}/results',
    httpMethod: 'get',
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/tasks/$TASK_ID/results \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/batches \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    name: 'get',
    endpoint: '/v2/batches/{batch_id}',
    httpMethod: 'get',
    ...
    response:
      "{ id: string; completed: boolean; completed_count: number; created_at: string; progress: number; status: 'success'; tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]; completed_at?: string; }",
    markdown:
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/batches/$BATCH_ID \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    name: 'progress',
    endpoint: '/v2/batches/{batch_id}/progress',
    httpMethod: 'get',
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/batches/$BATCH_ID/progress \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    name: 'get_driver',
    endpoint: '/v2/domain-knowledge/driver',
    httpMethod: 'get',
    summary: 'Get Driver',
    description:
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/domain-knowledge/driver \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY"',
      },
    },
  },
  {
    ...
    params: [
      ...
      'locale?: string;',
      "storage?: { url: string; object_name?: string; type?: 's3' | 'gcs' | 'do' | 'oci'; };",
    ],
    response:
      "{ data: { browser_actions?: { results: object[]; success: boolean; total_duration: number; }; cookies?: object[]; eval?: object[]; fetch?: object[]; headers?: object; html?: string; links?: string[]; markdown?: string; network_capture?: { filter: object; results: object[]; errorMessage?: string; }[]; pages_html?: string[]; parsing?: { entities: object; status: 'success'; } | { error: string; status: 'error'; } | object; redirects?: { status_code: number; url: string; }[]; screenshots?: object[]; }; metadata: { agent?: string; driver?: string; localization_id?: string; query_duration?: number; query_time?: string; response_parameters?: object; tag?: string; }; status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'; task_id: string; url: string; debug?: { performance_metrics?: object; proxy_total_bytes_usage?: number; transformed_output?: object; userbrowser?: object; }; pagination?: { next_page_params: object; } | { next_page_params: object; }[]; status_code?: number; warnings?: string[]; }",
    markdown:
      "## run\n\n`client.media.run(url: string, country?: string, expected_mime_types?: string[], locale?: string, storage?: { url: string; object_name?: string; type?: 's3' | 'gcs' | 'do' | 'oci'; }): { data: object; metadata: object; status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'; task_id: string; url: string; debug?: object; pagination?: object | object[]; status_code?: number; warnings?: string[]; }`\n\n**post** `/v2/media`\n\nDownload media from a URL. Waits for the result before responding.\n\n### Parameters\n\n- `url: string`\n\n- `country?: string`\n\n- `expected_mime_types?: string[]`\n\n- `locale?: string`\n\n- `storage?: { url: string; object_name?: string; type?: 's3' | 'gcs' | 'do' | 'oci'; }`\n  - `url: string`\n  - `object_name?: string`\n  - `type?: 's3' | 'gcs' | 'do' | 'oci'`\n\n### Returns\n\n- `{ data: { browser_actions?: { results: object[]; success: boolean; total_duration: number; }; cookies?: object[]; eval?: object[]; fetch?: object[]; headers?: object; html?: string; links?: string[]; markdown?: string; network_capture?: { filter: object; results: object[]; errorMessage?: string; }[]; pages_html?: string[]; parsing?: { entities: object; status: 'success'; } | { error: string; status: 'error'; } | object; redirects?: { status_code: number; url: string; }[]; screenshots?: object[]; }; metadata: { agent?: string; driver?: string; localization_id?: string; query_duration?: number; query_time?: string; response_parameters?: object; tag?: string; }; status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'; task_id: string; url: string; debug?: { performance_metrics?: object; proxy_total_bytes_usage?: number; transformed_output?: object; userbrowser?: object; }; pagination?: { next_page_params: object; } | { next_page_params: object; }[]; status_code?: number; warnings?: string[]; }`\n\n  - `data: { browser_actions?: { results: { duration: number; name: string; status: 'no-run' | 'in-progress' | 'done' | 'error' | 'skipped'; error?: string; result?: object; }[]; success: boolean; total_duration: number; }; cookies?: object[]; eval?: object[]; fetch?: object[]; headers?: object; html?: string; links?: string[]; markdown?: string; network_capture?: { filter: { validation: boolean; wait_for_requests_count: number; method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { type: 'exact' | 'contains'; value: string; }; wait_for_requests_count_timeout?: number; }; results: { request: { headers: object; method: string; resource_type: string; url: string; body?: string; }; response: { body: string; headers: object; serialization: 'none' | 'base64'; status: number; status_text: string; }; }[]; errorMessage?: string; }[]; pages_html?: string[]; parsing?: { entities: object; status: 'success'; } | { error: string; status: 'error'; } | object; redirects?: { status_code: number; url: string; }[]; screenshots?: object[]; }`\n  - `metadata: { agent?: string; driver?: string; localization_id?: string; query_duration?: number; query_time?: string; response_parameters?: object; tag?: string; }`\n  - `status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'`\n  - `task_id: string`\n  - `url: string`\n  - `debug?: { performance_metrics?: object; proxy_total_bytes_usage?: number; transformed_output?: object; userbrowser?: object; }`\n  - `pagination?: { next_page_params: object; } | { next_page_params: object; }[]`\n  - `status_code?: number`\n  - `warnings?: string[]`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.media.run({ url: 'https://example.com' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/media \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "url": "https://example.com"\n        }\'',
      },
    },
  },
  {
    name: 'run_async',
    endpoint: '/v2/media/async',
    httpMethod: 'post',
    ...
    response:
      "{ status: 'success'; task: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }; }",
    markdown:
      "## run_async\n\n`client.media.runAsync(url: string, callback_url?: string, country?: string, expected_mime_types?: string[], locale?: string, storage?: { url: string; object_name?: string; type?: 's3' | 'gcs' | 'do' | 'oci'; }, storage_compress?: boolean, storage_object_name?: string, storage_type?: string, storage_url?: string): { status: 'success'; task: object; }`\n\n**post** `/v2/media/async`\n\nDownload media from a URL asynchronously. Returns a task ID immediately.\n\n### Parameters\n\n- `url: string`\n\n- `callback_url?: string`\n  URL to call back when async operation completes\n\n- `country?: string`\n\n- `expected_mime_types?: string[]`\n\n- `locale?: string`\n\n- `storage?: { url: string; object_name?: string; type?: 's3' | 'gcs' | 'do' | 'oci'; }`\n  - `url: string`\n  - `object_name?: string`\n  - `type?: 's3' | 'gcs' | 'do' | 'oci'`\n\n- `storage_compress?: boolean`\n  Whether to compress stored data\n\n- `storage_object_name?: string`\n  Custom name for the stored object\n\n- `storage_type?: string`\n  Type of storage to use for results\n\n- `storage_url?: string`\n  URL for storage location\n\n### Returns\n\n- `{ status: 'success'; task: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }; }`\n  Response when an async media download task is created successfully.\n\n  - `status: 'success'`\n  - `task: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.media.runAsync({ url: 'https://example.com' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/media/async \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "url": "https://example.com",\n          "callback_url": "https://example.com/webhook/callback",\n          "storage_compress": true,\n          "storage_object_name": "result-2024-01-15.json",\n          "storage_type": "s3",\n          "storage_url": "s3://bucket-name/path/to/object"\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/serp \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "search_engine": "google_search",\n          "country": "US",\n          "device": "desktop",\n          "domain": "com",\n          "locale": "en",\n          "location": "New York, New York, United States",\n          "num_results": 10,\n          "page": 1,\n          "parse": true,\n          "query": "nimble web data",\n          "render": false,\n          "resolve_url": true,\n          "show_hidden_results": false\n        }\'',
      },
    },
  },
  {
    name: 'run_async',
    endpoint: '/v2/serp/async',
    httpMethod: 'post',
    ...
    response:
      "{ status: 'success'; task: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }; }",
    markdown:
      "## run_async\n\n`client.serp.runAsync(search_engine: string, callback_url?: string, country?: string, device?: 'desktop' | 'mobile', domain?: string, locale?: string, location?: string, num_results?: number, page?: number, parse?: boolean, query?: string, render?: boolean, resolve_url?: boolean, show_hidden_results?: boolean, storage_compress?: boolean, storage_object_name?: string, storage_type?: string, storage_url?: string): { status: 'success'; task: object; }`\n\n**post** `/v2/serp/async`\n\nSERP Async Endpoint\n\n### Parameters\n\n- `search_engine: string`\n  The search engine to query.\n\n- `callback_url?: string`\n  URL to call back when async operation completes\n\n- `country?: string`\n  ISO Alpha-2 country code used to access the target search engine (e.g. US, DE, GB).\n\n- `device?: 'desktop' | 'mobile'`\n  Device type used for the search request.\n\n- `domain?: string`\n  Top-level domain for the search engine (e.g. \"com\", \"co.uk\", \"de\").\n\n- `locale?: string`\n  Locale used for the search request.\n\n- `location?: string`\n  Geo-location for the search (canonical Google location name).\n\n- `num_results?: number`\n  Number of results to return (1–100).\n\n- `page?: number`\n  The result page number for pagination.\n\n- `parse?: boolean`\n  When true, the SERP response is parsed into structured JSON.\n\n- `query?: string`\n  The search keyword or phrase to query.\n\n- `render?: boolean`\n  Whether to render the page in a browser before extracting.\n\n- `resolve_url?: boolean`\n  When true, search result links that point at a search-engine redirector are resolved to their final destination URLs. Best-effort within a time budget: links that cannot be resolved in time are returned unchanged.\n\n- `show_hidden_results?: boolean`\n  When true, disables Google result filtering (filter=0) so omitted/duplicate and highly similar pages are also returned. Applies to Google search engines.\n\n- `storage_compress?: boolean`\n  Whether to compress stored data\n\n- `storage_object_name?: string`\n  Custom name for the stored object\n\n- `storage_type?: string`\n  Type of storage to use for results\n\n- `storage_url?: string`\n  URL for storage location\n\n### Returns\n\n- `{ status: 'success'; task: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }; }`\n  Response when an async SERP task is created successfully.\n\n  - `status: 'success'`\n  - `task: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.serp.runAsync({ search_engine: 'google_search' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/serp/async \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "search_engine": "google_search",\n          "callback_url": "https://example.com/webhook/callback",\n          "country": "US",\n          "device": "desktop",\n          "domain": "com",\n          "locale": "en",\n          "location": "New York, New York, United States",\n          "num_results": 10,\n          "page": 1,\n          "parse": true,\n          "query": "nimble web data",\n          "render": false,\n          "resolve_url": true,\n          "show_hidden_results": false,\n          "storage_compress": true,\n          "storage_object_name": "result-2024-01-15.json",\n          "storage_type": "s3",\n          "storage_url": "s3://bucket-name/path/to/object"\n        }\'',
      },
    },
  },
  {
    name: 'run_batch',
    endpoint: '/v2/serp/batch',
    httpMethod: 'post',
    ...
    params: [
      "inputs: { callback_url?: string; country?: string; device?: 'desktop' | 'mobile'; domain?: string; locale?: string; location?: string; num_results?: number; page?: number; parse?: boolean; query?: string; render?: boolean; resolve_url?: boolean; search_engine?: string; show_hidden_results?: boolean; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; }[];",
      "shared_inputs?: { callback_url?: string; country?: string; device?: 'desktop' | 'mobile'; domain?: string; locale?: string; location?: string; num_results?: number; page?: number; parse?: boolean; query?: string; render?: boolean; resolve_url?: boolean; search_engine?: string; show_hidden_results?: boolean; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; };",
    ],
    response:
      "{ batch_id: string; batch_size: number; tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]; }",
    markdown:
      "## run_batch\n\n`client.serp.runBatch(inputs: { callback_url?: string; country?: string; device?: 'desktop' | 'mobile'; domain?: string; locale?: string; location?: string; num_results?: number; page?: number; parse?: boolean; query?: string; render?: boolean; resolve_url?: boolean; search_engine?: string; show_hidden_results?: boolean; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; }[], shared_inputs?: { callback_url?: string; country?: string; device?: 'desktop' | 'mobile'; domain?: string; locale?: string; location?: string; num_results?: number; page?: number; parse?: boolean; query?: string; render?: boolean; resolve_url?: boolean; search_engine?: string; show_hidden_results?: boolean; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; }): { batch_id: string; batch_size: number; tasks: object[]; }`\n\n**post** `/v2/serp/batch`\n\nSERP Batch Endpoint\n\n### Parameters\n\n- `inputs: { callback_url?: string; country?: string; device?: 'desktop' | 'mobile'; domain?: string; locale?: string; location?: string; num_results?: number; page?: number; parse?: boolean; query?: string; render?: boolean; resolve_url?: boolean; search_engine?: string; show_hidden_results?: boolean; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; }[]`\n  Array of SERP requests. Each object can include search parameters and async/storage settings.\n\n- `shared_inputs?: { callback_url?: string; country?: string; device?: 'desktop' | 'mobile'; domain?: string; locale?: string; location?: string; num_results?: number; page?: number; parse?: boolean; query?: string; render?: boolean; resolve_url?: boolean; search_engine?: string; show_hidden_results?: boolean; storage_compress?: boolean; storage_object_name?: string; storage_type?: string; storage_url?: string; }`\n  Shared parameters applied to the entire batch. Can include search parameters and async/storage settings.\n  - `callback_url?: string`\n    URL to call back when async operation completes\n  - `country?: string`\n    ISO Alpha-2 country code used to access the target search engine (e.g. US, DE, GB).\n  - `device?: 'desktop' | 'mobile'`\n    Device type used for the search request.\n  - `domain?: string`\n    Top-level domain for the search engine (e.g. \"com\", \"co.uk\", \"de\").\n  - `locale?: string`\n    Locale used for the search request.\n  - `location?: string`\n    Geo-location for the search (canonical Google location name).\n  - `num_results?: number`\n    Number of results to return (1–100).\n  - `page?: number`\n    The result page number for pagination.\n  - `parse?: boolean`\n    When true, the SERP response is parsed into structured JSON.\n  - `query?: string`\n    The search keyword or phrase to query.\n  - `render?: boolean`\n    Whether to render the page in a browser before extracting.\n  - `resolve_url?: boolean`\n    When true, search result links that point at a search-engine redirector are resolved to their final destination URLs. Best-effort within a time budget: links that cannot be resolved in time are returned unchanged.\n  - `search_engine?: string`\n    The search engine to query.\n  - `show_hidden_results?: boolean`\n    When true, disables Google result filtering (filter=0) so omitted/duplicate and highly similar pages are also returned. Applies to Google search engines.\n  - `storage_compress?: boolean`\n    Whether to compress stored data\n  - `storage_object_name?: string`\n    Custom name for the stored object\n  - `storage_type?: string`\n    Type of storage to use for results\n  - `storage_url?: string`\n    URL for storage location\n\n### Returns\n\n- `{ batch_id: string; batch_size: number; tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]; }`\n  Response when a batch of SERP tasks is created successfully.\n\n  - `batch_id: string`\n  - `batch_size: number`\n  - `tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'queued' | 'in_progress' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract' | 'fast-serp' | 'labs'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; queue?: string; status_code?: number; }[]`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.serp.runBatch({ inputs: [{}] });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/serp/batch \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "inputs": [\n            {}\n          ]\n        }\'',
      },
    },
  },
  {
    name: 'run',
    endpoint: '/v2/fast-serp',
    httpMethod: 'post',
    summary: 'Fast SERP',
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/fast-serp \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $NIMBLE_API_KEY" \\\n    -d \'{\n          "search_engine": "google_search",\n          "country": "US",\n          "device": "desktop",\n          "domain": "com",\n          "locale": "en",\n          "location": "New York, New York, United States",\n          "num_results": 10,\n          "page": 1,\n          "parse": true,\n          "query": "nimble web data",\n          "render": false,\n          "resolve_url": true,\n          "show_hidden_results": false\n        }\'',
      },
    },
  },
  {
    ...
    endpoint: '/v2/jobs',
    httpMethod: 'get',
    summary: 'List Jobs Public V2',
    description: 'List Jobs Public V2',
    stainlessPath: '(resource) jobs > (method) list',
    qualified: 'client.jobs.list',
    params: ['limit?: number;', 'offset?: number;'],
    response:
      "{ items: { id: string; name: string; created_at?: string; description?: string; destination?: { path: string; type: 'file' | 's3'; format?: 'jsonl' | 'csv' | 'parquet'; }; display_name?: string; extract_template_name?: string; inputs?: { type: 's3' | 'inline' | 'file'; data?: object[]; file_path?: string; node_data?: object; }; last_run_at?: string; last_run_status?: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; schedule?: { cron: string; enabled: boolean; }; updated_at?: string; }[]; limit: number; offset: number; total: number; }",
    markdown:
      "## list\n\n`client.jobs.list(limit?: number, offset?: number): { items: object[]; limit: number; offset: number; total: number; }`\n\n**get** `/v2/jobs`\n\nList Jobs Public V2\n\n### Parameters\n\n- `limit?: number`\n\n- `offset?: number`\n\n### Returns\n\n- `{ items: { id: string; name: string; created_at?: string; description?: string; destination?: { path: string; type: 'file' | 's3'; format?: 'jsonl' | 'csv' | 'parquet'; }; display_name?: string; extract_template_name?: string; inputs?: { type: 's3' | 'inline' | 'file'; data?: object[]; file_path?: string; node_data?: object; }; last_run_at?: string; last_run_status?: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; schedule?: { cron: string; enabled: boolean; }; updated_at?: string; }[]; limit: number; offset: number; total: number; }`\n\n  - `items: { id: string; name: string; created_at?: string; description?: string; destination?: { path: string; type: 'file' | 's3'; format?: 'jsonl' | 'csv' | 'parquet'; }; display_name?: string; extract_template_name?: string; inputs?: { type: 's3' | 'inline' | 'file'; data?: object[]; file_path?: string; node_data?: object; }; last_run_at?: string; last_run_status?: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; schedule?: { cron: string; enabled: boolean; }; updated_at?: string; }[]`\n  - `limit: number`\n  - `offset: number`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst jobs = await client.jobs.list();\n\nconsole.log(jobs);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/jobs',
      },
    },
  },
  {
    ...
    endpoint: '/v2/jobs',
    httpMethod: 'post',
    summary: 'Create Job Public V2',
    description: 'Create Job Public V2',
    ...
    perLanguage: {
      ...
      cli: {
        method: 'jobs create',
        example: 'nimble jobs create \\\n  --extract-template-name extract_template_name \\\n  --name name',
      },
      http: {
        example:
          'curl https://sdk.nimbleway.com/v2/jobs \\\n    -H \'Content-Type: application/json\' \\\n    -d \'{\n          "extract_template_name": "extract_template_name",\n          "name": "name"\n        }\'',
      },
    },
  },
  {
    ...
    httpMethod: 'delete',
    summary: 'Delete Job Public V2',
    description: 'Delete Job Public V2',
    ...
    perLanguage: {
      ...
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/jobs/$JOB_ID \\\n    -X DELETE',
      },
    },
  },
  {
    ...
    endpoint: '/v2/jobs/{job_id}',
    httpMethod: 'get',
    summary: 'Get Job Public V2',
    description: 'Get Job Public V2',
    ...
    response:
      "{ id: string; name: string; created_at?: string; description?: string; destination?: { path: string; type: 'file' | 's3'; format?: 'jsonl' | 'csv' | 'parquet'; }; display_name?: string; extract_template_name?: string; inputs?: { type: 's3' | 'inline' | 'file'; data?: object[]; file_path?: string; node_data?: object; }; last_run_at?: string; last_run_status?: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; schedule?: { cron: string; enabled: boolean; }; updated_at?: string; }",
    markdown:
      "## get\n\n`client.jobs.get(job_id: string): { id: string; name: string; created_at?: string; description?: string; destination?: object; display_name?: string; extract_template_name?: string; inputs?: object; last_run_at?: string; last_run_status?: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; schedule?: object; updated_at?: string; }`\n\n**get** `/v2/jobs/{job_id}`\n\nGet Job Public V2\n\n### Parameters\n\n- `job_id: string`\n\n### Returns\n\n- `{ id: string; name: string; created_at?: string; description?: string; destination?: { path: string; type: 'file' | 's3'; format?: 'jsonl' | 'csv' | 'parquet'; }; display_name?: string; extract_template_name?: string; inputs?: { type: 's3' | 'inline' | 'file'; data?: object[]; file_path?: string; node_data?: object; }; last_run_at?: string; last_run_status?: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; schedule?: { cron: string; enabled: boolean; }; updated_at?: string; }`\n  A configured job: an agent plus its schedule, inputs, and destination.\n\n  - `id: string`\n  - `name: string`\n  - `created_at?: string`\n  - `description?: string`\n  - `destination?: { path: string; type: 'file' | 's3'; format?: 'jsonl' | 'csv' | 'parquet'; }`\n  - `display_name?: string`\n  - `extract_template_name?: string`\n  - `inputs?: { type: 's3' | 'inline' | 'file'; data?: object[]; file_path?: string; node_data?: object; }`\n  - `last_run_at?: string`\n  - `last_run_status?: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'`\n  - `schedule?: { cron: string; enabled: boolean; }`\n  - `updated_at?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst job = await client.jobs.get('job_id');\n\nconsole.log(job);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    endpoint: '/v2/jobs/{job_id}',
    httpMethod: 'patch',
    summary: 'Update Job Public V2',
    description: 'Update Job Public V2',
    ...
    perLanguage: {
      ...
      http: {
        example:
          "curl https://sdk.nimbleway.com/v2/jobs/$JOB_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -d '{}'",
      },
    },
  },
  {
    name: 'create',
    endpoint: '/v2/jobs/{job_id}/runs',
    httpMethod: 'post',
    summary: 'Trigger Job Run Public V2',
    ...
    perLanguage: {
      ...
      cli: {
        method: 'runs create',
        example: 'nimble jobs:runs create \\\n  --job-id job_id',
      },
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/jobs/$JOB_ID/runs \\\n    -X POST',
      },
    },
  },
  {
    name: 'get',
    endpoint: '/v2/jobs/runs/{run_id}',
    httpMethod: 'get',
    summary: 'Get Run Public V2',
    description: 'Get Run Public V2',
    stainlessPath: '(resource) jobs.runs > (method) get',
    qualified: 'client.jobs.runs.get',
    params: ['run_id: string;'],
    response:
      "{ id: string; created_at: string; job: { id: string; name: string; display_name?: string; extract_template_name?: string; schedule?: { cron: string; enabled: boolean; }; }; status: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; triggered_by: 'schedule' | 'manual'; error?: { errors_sample?: object[]; message?: string; step?: string; }; finished_at?: string; inputs_sample?: object[]; started_at?: string; summary?: { input_count?: number; match_rate?: number; result_count?: number; }; }",
    markdown:
      "## get\n\n`client.jobs.runs.get(run_id: string): { id: string; created_at: string; job: object; status: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; triggered_by: 'schedule' | 'manual'; error?: object; finished_at?: string; inputs_sample?: object[]; started_at?: string; summary?: object; }`\n\n**get** `/v2/jobs/runs/{run_id}`\n\nGet Run Public V2\n\n### Parameters\n\n- `run_id: string`\n\n### Returns\n\n- `{ id: string; created_at: string; job: { id: string; name: string; display_name?: string; extract_template_name?: string; schedule?: { cron: string; enabled: boolean; }; }; status: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; triggered_by: 'schedule' | 'manual'; error?: { errors_sample?: object[]; message?: string; step?: string; }; finished_at?: string; inputs_sample?: object[]; started_at?: string; summary?: { input_count?: number; match_rate?: number; result_count?: number; }; }`\n  Full detail for a single run.\n\n  - `id: string`\n  - `created_at: string`\n  - `job: { id: string; name: string; display_name?: string; extract_template_name?: string; schedule?: { cron: string; enabled: boolean; }; }`\n  - `status: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'`\n  - `triggered_by: 'schedule' | 'manual'`\n  - `error?: { errors_sample?: object[]; message?: string; step?: string; }`\n  - `finished_at?: string`\n  - `inputs_sample?: object[]`\n  - `started_at?: string`\n  - `summary?: { input_count?: number; match_rate?: number; result_count?: number; }`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst run = await client.jobs.runs.get('run_id');\n\nconsole.log(run);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/jobs/runs/$RUN_ID',
      },
    },
  },
  {
    name: 'cancel',
    endpoint: '/v2/jobs/runs/{run_id}/cancel',
    httpMethod: 'post',
    summary: 'Cancel Run Public V2',
    description: 'Cancel Run Public V2',
    ...
    perLanguage: {
      ...
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/jobs/runs/$RUN_ID/cancel \\\n    -X POST',
      },
    },
  },
  {
    ...
    endpoint: '/v2/jobs/{job_id}/runs',
    httpMethod: 'get',
    summary: 'List Job Runs Public V2',
    description: 'List Job Runs Public V2',
    stainlessPath: '(resource) jobs.runs > (method) list',
    qualified: 'client.jobs.runs.list',
    params: ['job_id: string;', 'limit?: number;', 'offset?: number;'],
    response:
      "{ items: { id: string; created_at: string; job_id: string; status: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; triggered_by: 'schedule' | 'manual'; finished_at?: string; input_count?: number; result_count?: number; started_at?: string; }[]; limit: number; offset: number; total: number; }",
    markdown:
      "## list\n\n`client.jobs.runs.list(job_id: string, limit?: number, offset?: number): { items: object[]; limit: number; offset: number; total: number; }`\n\n**get** `/v2/jobs/{job_id}/runs`\n\nList Job Runs Public V2\n\n### Parameters\n\n- `job_id: string`\n\n- `limit?: number`\n\n- `offset?: number`\n\n### Returns\n\n- `{ items: { id: string; created_at: string; job_id: string; status: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; triggered_by: 'schedule' | 'manual'; finished_at?: string; input_count?: number; result_count?: number; started_at?: string; }[]; limit: number; offset: number; total: number; }`\n\n  - `items: { id: string; created_at: string; job_id: string; status: 'PENDING' | 'RUNNING' | 'SUCCESS' | 'FAILED' | 'CANCELLED' | 'TIMEOUT' | 'WARNING'; triggered_by: 'schedule' | 'manual'; finished_at?: string; input_count?: number; result_count?: number; started_at?: string; }[]`\n  - `limit: number`\n  - `offset: number`\n  - `total: number`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst runs = await client.jobs.runs.list('job_id');\n\nconsole.log(runs);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'list',
    endpoint: '/v2/jobs/runs/{run_id}/artifacts',
    httpMethod: 'get',
    summary: 'List Run Artifacts Public V2',
    description: 'List Run Artifacts Public V2',
    ...
    perLanguage: {
      ...
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/jobs/runs/$RUN_ID/artifacts',
      },
    },
  },
  {
    name: 'get',
    endpoint: '/v2/jobs/runs/{run_id}/artifacts/{artifact_id}',
    httpMethod: 'get',
    summary: 'Get Run Artifact Public V2',
    description: 'Get Run Artifact Public V2',
    stainlessPath: '(resource) jobs.runs.artifacts > (method) get',
    qualified: 'client.jobs.runs.artifacts.get',
    params: ['run_id: string;', 'artifact_id: number;'],
    response: '{ id: string; created_at: string; description: string; type: string; }',
    markdown:
      "## get\n\n`client.jobs.runs.artifacts.get(run_id: string, artifact_id: number): { id: string; created_at: string; description: string; type: string; }`\n\n**get** `/v2/jobs/runs/{run_id}/artifacts/{artifact_id}`\n\nGet Run Artifact Public V2\n\n### Parameters\n\n- `run_id: string`\n\n- `artifact_id: number`\n\n### Returns\n\n- `{ id: string; created_at: string; description: string; type: string; }`\n  A file produced by a run.\n\n  - `id: string`\n  - `created_at: string`\n  - `description: string`\n  - `type: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst artifact = await client.jobs.runs.artifacts.get(0, { run_id: 'run_id' });\n\nconsole.log(artifact);\n```",
    perLanguage: {
      typescript: {
      ...
      cli: {
        ...
        example: 'nimble jobs:runs:artifacts get \\\n  --run-id run_id \\\n  --artifact-id 0',
      },
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/jobs/runs/$RUN_ID/artifacts/$ARTIFACT_ID',
      },
    },
  },
  {
    name: 'download_url',
    endpoint: '/v2/jobs/runs/{run_id}/artifacts/{artifact_id}/download-url',
    httpMethod: 'get',
    summary: 'Get Run Artifact Download Url Public V2',
    description: 'Get Run Artifact Download Url Public V2',
    ...
    perLanguage: {
      ...
      cli: {
        ...
        example: 'nimble jobs:runs:artifacts download-url \\\n  --run-id run_id \\\n  --artifact-id 0',
      },
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/jobs/runs/$RUN_ID/artifacts/$ARTIFACT_ID/download-url',
      },
    },
  },
  {
    name: 'preview',
    endpoint: '/v2/jobs/runs/{run_id}/artifacts/{artifact_id}/preview',
    httpMethod: 'get',
    summary: 'Preview Run Artifact Public V2',
    description: 'Preview Run Artifact Public V2',
    ...
    perLanguage: {
      ...
      cli: {
        ...
        example: 'nimble jobs:runs:artifacts preview \\\n  --run-id run_id \\\n  --artifact-id 0',
      },
      http: {
        example: 'curl https://sdk.nimbleway.com/v2/jobs/runs/$RUN_ID/artifacts/$ARTIFACT_ID/preview',
      },
    },
  },
];
