...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    markdown:
      "## list\n\n`client.agents.list(limit?: number, managed_by?: 'nimble' | 'community' | 'self_managed', offset?: number, privacy?: 'public' | 'private' | 'all', search?: string): { display_name: string; is_public: boolean; name: string; description?: string; domain?: string; entity_type?: string; managed_by?: string; vertical?: string; }[]`\n\n**get** `/v1/agents`\n\nList Agent Templates\n\n### Parameters\n\n- `limit?: number`\n  Number of results per page\n\n- `managed_by?: 'nimble' | 'community' | 'self_managed'`\n  Filter templates by attribution\n\n- `offset?: number`\n  Pagination offset\n\n- `privacy?: 'public' | 'private' | 'all'`\n  Filter by privacy level\n\n- `search?: string`\n  Search templates by name, domain, or vertical\n\n### Returns\n\n- `{ display_name: string; is_public: boolean; name: string; description?: string; domain?: string; entity_type?: string; managed_by?: string; vertical?: string; }[]`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst agents = await client.agents.list();\n\nconsole.log(agents);\n```",
  },
  {
    name: 'get',
    ...
    markdown:
      "## get\n\n`client.agents.get(template_name: string): { display_name: string; is_public: boolean; name: string; description?: string; domain?: string; entity_type?: string; feature_flags?: object; input_properties?: object[]; managed_by?: string; output_schema?: object; vertical?: string; }`\n\n**get** `/v1/agents/{template_name}`\n\nGet Agent Template\n\n### Parameters\n\n- `template_name: string`\n\n### Returns\n\n- `{ display_name: string; is_public: boolean; name: string; description?: string; domain?: string; entity_type?: string; feature_flags?: { is_localization_supported?: boolean; is_pagination_supported?: boolean; }; input_properties?: { default?: string; description?: string; examples?: string[]; is_localization_param?: boolean; name?: string; required?: boolean; rules?: string[]; type?: string; }[]; managed_by?: string; output_schema?: object; vertical?: string; }`\n\n  - `display_name: string`\n  - `is_public: boolean`\n  - `name: string`\n  - `description?: string`\n  - `domain?: string`\n  - `entity_type?: string`\n  - `feature_flags?: { is_localization_supported?: boolean; is_pagination_supported?: boolean; }`\n  - `input_properties?: { default?: string; description?: string; examples?: string[]; is_localization_param?: boolean; name?: string; required?: boolean; rules?: string[]; type?: string; }[]`\n  - `managed_by?: string`\n  - `output_schema?: object`\n  - `vertical?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst agent = await client.agents.get('template_name');\n\nconsole.log(agent);\n```",
  },
  {
    name: 'publish',
    ...
    markdown:
      "## publish\n\n`client.agents.publish(agent_name: string, version_id: string): { agent_name: string; published_version_id: string; }`\n\n**post** `/v1/agents/{agent_name}/publish`\n\nPublish Agent Version\n\n### Parameters\n\n- `agent_name: string`\n\n- `version_id: string`\n\n### Returns\n\n- `{ agent_name: string; published_version_id: string; }`\n\n  - `agent_name: string`\n  - `published_version_id: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.agents.publish('agent_name', { version_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });\n\nconsole.log(response);\n```",
  },
  {
    name: 'run',
    ...
    response:
      "{ data: { browser_actions?: { results: object[]; success: boolean; total_duration: number; }; cookies?: object[]; eval?: object[]; fetch?: object[]; headers?: object; html?: string; markdown?: string; network_capture?: { filter: object; results: object[]; errorMessage?: string; }[]; pages_html?: string[]; parsing?: { entities: object; status: 'success'; } | { error: string; status: 'error'; } | object; redirects?: { status_code: number; url: string; }[]; screenshots?: object[]; }; metadata: { agent?: string; driver?: string; localization_id?: string; query_duration?: number; query_time?: string; response_parameters?: object; tag?: string; }; status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'; task_id: string; url: string; debug?: { performance_metrics?: object; proxy_total_bytes_usage?: number; transformed_output?: object; userbrowser?: object; }; pagination?: { next_page_params: object; } | { next_page_params: object; }[]; status_code?: number; warnings?: string[]; }",
    markdown:
      "## run\n\n`client.agents.run(agent: string, params: object, formats?: 'html' | 'markdown' | 'screenshot' | 'headers'[], localization?: boolean): { data: object; metadata: object; status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'; task_id: string; url: string; debug?: object; pagination?: object | object[]; status_code?: number; warnings?: string[]; }`\n\n**post** `/v1/agents/run`\n\nExecute WSA Realtime Endpoint\n\n### Parameters\n\n- `agent: string`\n\n- `params: object`\n\n- `formats?: 'html' | 'markdown' | 'screenshot' | 'headers'[]`\n  Response formats to include. All disabled by default.\n\n- `localization?: boolean`\n\n### Returns\n\n- `{ data: { browser_actions?: { results: object[]; success: boolean; total_duration: number; }; cookies?: object[]; eval?: object[]; fetch?: object[]; headers?: object; html?: string; markdown?: string; network_capture?: { filter: object; results: object[]; errorMessage?: string; }[]; pages_html?: string[]; parsing?: { entities: object; status: 'success'; } | { error: string; status: 'error'; } | object; redirects?: { status_code: number; url: string; }[]; screenshots?: object[]; }; metadata: { agent?: string; driver?: string; localization_id?: string; query_duration?: number; query_time?: string; response_parameters?: object; tag?: string; }; status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'; task_id: string; url: string; debug?: { performance_metrics?: object; proxy_total_bytes_usage?: number; transformed_output?: object; userbrowser?: object; }; pagination?: { next_page_params: object; } | { next_page_params: object; }[]; status_code?: number; warnings?: string[]; }`\n\n  - `data: { browser_actions?: { results: { duration: number; name: string; status: 'no-run' | 'in-progress' | 'done' | 'error' | 'skipped'; error?: string; result?: object; }[]; success: boolean; total_duration: number; }; cookies?: object[]; eval?: object[]; fetch?: object[]; headers?: object; html?: string; markdown?: string; network_capture?: { filter: { validation: boolean; wait_for_requests_count: number; method?: 'GET' | 'HEAD' | 'POST' | 'PUT' | 'DELETE' | 'CONNECT' | 'OPTIONS' | 'TRACE' | 'PATCH'; resource_type?: string | string[]; status_code?: number | number[]; url?: { type: 'exact' | 'contains'; value: string; }; wait_for_requests_count_timeout?: number; }; results: { request: { headers: object; method: string; resource_type: string; url: string; body?: string; }; response: { body: string; headers: object; serialization: 'none' | 'base64'; status: number; status_text: string; }; }[]; errorMessage?: string; }[]; pages_html?: string[]; parsing?: { entities: object; status: 'success'; } | { error: string; status: 'error'; } | object; redirects?: { status_code: number; url: string; }[]; screenshots?: object[]; }`\n  - `metadata: { agent?: string; driver?: string; localization_id?: string; query_duration?: number; query_time?: string; response_parameters?: object; tag?: string; }`\n  - `status: 'success' | 'skipped' | 'fatal' | 'error' | 'postponed' | 'ignored' | 'rejected' | 'blocked'`\n  - `task_id: string`\n  - `url: string`\n  - `debug?: { performance_metrics?: object; proxy_total_bytes_usage?: number; transformed_output?: object; userbrowser?: object; }`\n  - `pagination?: { next_page_params: object; } | { next_page_params: object; }[]`\n  - `status_code?: number`\n  - `warnings?: string[]`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.agents.run({\n  agent: 'agent',\n  params: { foo: 'bar' },\n});\n\nconsole.log(response);\n```",
  },
  {
    name: 'run_async',
    ...
    stainlessPath: '(resource) agents > (method) run_async',
    qualified: 'client.agents.runAsync',
    params: [
      'agent: string;',
      'params: object;',
      'callback_url?: string;',
    ...
    markdown:
      "## run_async\n\n`client.agents.runAsync(agent: string, params: object, callback_url?: string, formats?: 'html' | 'markdown' | 'screenshot' | 'headers'[], localization?: boolean, storage_compress?: boolean, storage_object_name?: string, storage_type?: string, storage_url?: string): { status: 'success'; task: object; }`\n\n**post** `/v1/agents/async`\n\nExecute WSA Async Endpoint\n\n### Parameters\n\n- `agent: string`\n\n- `params: object`\n\n- `callback_url?: string`\n  URL to call back when async operation completes\n\n- `formats?: 'html' | 'markdown' | 'screenshot' | 'headers'[]`\n  Response formats to include. All disabled by default.\n\n- `localization?: boolean`\n\n- `storage_compress?: boolean`\n  Whether to compress stored data\n\n- `storage_object_name?: string`\n  Custom name for the stored object\n\n- `storage_type?: string`\n  Type of storage to use for results\n\n- `storage_url?: string`\n  URL for storage location\n\n### Returns\n\n- `{ status: 'success'; task: object; }`\n\n  - `status: 'success'`\n  - `task: object`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.agents.runAsync({\n  agent: 'agent',\n  params: { foo: 'bar' },\n});\n\nconsole.log(response);\n```",
  },
  {
    name: 'run_batch',
    ...
    stainlessPath: '(resource) agents > (method) run_batch',
    qualified: 'client.agents.runBatch',
    params: [
    ...
    response:
      "{ batch_id: string; batch_size: number; tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; status_code?: number; }[]; }",
    markdown:
      "## run_batch\n\n`client.agents.runBatch(inputs: { formats?: 'html' | 'markdown' | 'screenshot' | 'headers'[]; localization?: boolean; params?: object; }[], shared_inputs: { agent: string; formats?: 'html' | 'markdown' | 'screenshot' | 'headers'[]; localization?: boolean; params?: object; }): { batch_id: string; batch_size: number; tasks: object[]; }`\n\n**post** `/v1/agents/batch`\n\nExecute WSA Batch Endpoint\n\n### Parameters\n\n- `inputs: { formats?: 'html' | 'markdown' | 'screenshot' | 'headers'[]; localization?: boolean; params?: object; }[]`\n\n- `shared_inputs: { agent: string; formats?: 'html' | 'markdown' | 'screenshot' | 'headers'[]; localization?: boolean; params?: object; }`\n  - `agent: string`\n  - `formats?: 'html' | 'markdown' | 'screenshot' | 'headers'[]`\n    Response formats to include. All disabled by default.\n  - `localization?: boolean`\n  - `params?: object`\n\n### Returns\n\n- `{ batch_id: string; batch_size: number; tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; status_code?: number; }[]; }`\n  Response when a batch of extract tasks is created successfully.\n\n  - `batch_id: string`\n  - `batch_size: number`\n  - `tasks: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; status_code?: number; }[]`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst response = await client.agents.runBatch({\n  inputs: [{}],\n  shared_inputs: { agent: 'agent' },\n});\n\nconsole.log(response);\n```",
  },
  {
    name: 'create',
    ...
    stainlessPath: '(resource) agents.generations > (method) create',
    qualified: 'client.agents.generations.create',
    params: [
  ...
  },
  {
    ...
    stainlessPath: '(resource) agents.generations > (method) get',
    qualified: 'client.agents.generations.get',
    params: ['generation_id: string;'],
    response:
      '{ id: string; status: string; agent_name?: string; completed_at?: string; created_at?: string; error?: string; generated_version?: object; generated_version_id?: string; source_version_id?: string; started_at?: string; summary?: string; }',
    markdown:
      "## get\n\n`client.agents.generations.get(generation_id: string): { id: string; status: string; agent_name?: string; completed_at?: string; created_at?: string; error?: string; generated_version?: object; generated_version_id?: string; source_version_id?: string; started_at?: string; summary?: string; }`\n\n**get** `/v1/agents/generations/{generation_id}`\n\nGet Agent Generation\n\n### Parameters\n\n- `generation_id: string`\n\n### Returns\n\n- `{ id: string; status: string; agent_name?: string; completed_at?: string; created_at?: string; error?: string; generated_version?: object; generated_version_id?: string; source_version_id?: string; started_at?: string; summary?: string; }`\n\n  - `id: string`\n  - `status: string`\n  - `agent_name?: string`\n  - `completed_at?: string`\n  - `created_at?: string`\n  - `error?: string`\n  - `generated_version?: object`\n  - `generated_version_id?: string`\n  - `source_version_id?: string`\n  - `started_at?: string`\n  - `summary?: string`\n\n### Example\n\n```typescript\nimport Nimble from '@nimble-way/nimble-js';\n\nconst client = new Nimble();\n\nconst generation = await client.agents.generations.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(generation);\n```",
  },
  {
    name: 'list',
    endpoint: '/v1/crawl',
