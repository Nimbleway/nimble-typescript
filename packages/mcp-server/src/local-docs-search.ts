...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/extract/async \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\" \\\n    -d '{\n          \"url\": \"url\",\n          \"browser_actions\": [\n            {\n              \"goto\": \"https://example.com/login\"\n            },\n            {\n              \"wait_for_element\": \"#login-form\"\n            },\n            {\n              \"fill\": {\n                \"selector\": \"#username\",\n                \"value\": \"user@example.com\",\n                \"mode\": \"type\"\n              }\n            },\n            {\n              \"fill\": {\n                \"selector\": \"#password\",\n                \"value\": \"password123\",\n                \"mode\": \"type\"\n              }\n            },\n            {\n              \"click\": \"#submit\"\n            },\n            {\n              \"screenshot\": {\n                \"full_page\": true\n              }\n            }\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/extract/batch \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\" \\\n    -d '{\n          \"inputs\": [\n            {}\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ links: { url: string; description?: string; title?: string; }[]; success: boolean; task_id: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/map \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\" \\\n    -d '{\n          \"url\": \"url\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/search \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\" \\\n    -d '{\n          \"query\": \"x\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "agent run",
        "example": "nimble agent run \\\n  --api-key 'My API Key' \\\n  --agent agent \\\n  --params '{foo: bar}'"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/agents/run \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\" \\\n    -d '{\n          \"agent\": \"agent\",\n          \"params\": {\n            \"foo\": \"bar\"\n          }\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "agent run_async",
        "example": "nimble agent run-async \\\n  --api-key 'My API Key' \\\n  --agent agent \\\n  --params '{foo: bar}'"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/agents/async \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\" \\\n    -d '{\n          \"agent\": \"agent\",\n          \"params\": {\n            \"foo\": \"bar\"\n          }\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "agent run_batch",
        "example": "nimble agent run-batch \\\n  --api-key 'My API Key' \\\n  --input '{}' \\\n  --shared-inputs '{agent: agent}'"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/agents/batch \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\" \\\n    -d '{\n          \"inputs\": [\n            {}\n          ],\n          \"shared_inputs\": {\n            \"agent\": \"agent\"\n          }\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ display_name: string; is_public: boolean; name: string; description?: string; domain?: string; entity_type?: string; managed_by?: string; vertical?: string; }[]",
  ...
  },
  {
    ...
    "response": "{ id: string; status: string; agent_name?: string; completed_at?: string; created_at?: string; error?: string; generated_version?: { id: string; agent_name: string; created_at: string; input_schema: object; metadata: { data_source?: string; description?: string; display_name?: string; domain?: string; entity_type?: string; tags?: string[]; vertical?: string; }; output_schema: object; steps: object[]; version_number: number; output_sample_data?: object; }; generated_version_id?: string; source_version_id?: string; started_at?: string; summary?: string; }",
    "perLanguage": {
      "typescript": {
      ...
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/agents/generations \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\" \\\n    -d '{\n          \"prompt\": \"prompt\",\n          \"url\": \"url\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "agent get_generation",
        "example": "nimble agent get-generation \\\n  --api-key 'My API Key' \\\n  --generation-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/agents/generations/$GENERATION_ID \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "agent publish",
        "example": "nimble agent publish \\\n  --api-key 'My API Key' \\\n  --agent-name agent_name \\\n  --version-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/agents/$AGENT_NAME/publish \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\" \\\n    -d '{\n          \"version_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n        }'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "crawl status",
        "example": "nimble crawl status \\\n  --api-key 'My API Key' \\\n  --id 123e4567-e89b-12d3-a456-426614174000"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/crawl/$ID \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "crawl terminate",
        "example": "nimble crawl terminate \\\n  --api-key 'My API Key' \\\n  --id 123e4567-e89b-12d3-a456-426614174000"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/crawl/$ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\""
      }
  ...
  },
  {
    ...
    "response": "{ data: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; status_code?: number; }[]; pagination: { has_next: boolean; next_cursor: string; total: number; }; }",
  ...
  },
  {
    ...
    "response": "{ task: { id: string; _query: object; created_at: string; input: object; state: 'pending' | 'success' | 'error'; status_url: string; account_name?: string; api_type?: 'web' | 'serp' | 'ecommerce' | 'social' | 'media' | 'agent' | 'extract'; batch_id?: string; download_url?: string; error?: string; error_type?: string; modified_at?: string; output_url?: string; status_code?: number; }; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "tasks get",
        "example": "nimble tasks get \\\n  --api-key 'My API Key' \\\n  --task-id 123e4567-e89b-12d3-a456-426614174000"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/tasks/$TASK_ID \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "tasks results",
        "example": "nimble tasks results \\\n  --api-key 'My API Key' \\\n  --task-id 123e4567-e89b-12d3-a456-426614174000"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/tasks/$TASK_ID/results \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/batches \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "batches get",
        "example": "nimble batches get \\\n  --api-key 'My API Key' \\\n  --batch-id 123e4567-e89b-12d3-a456-426614174000"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/batches/$BATCH_ID \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; completed: boolean; completed_count: number; progress: number; status: 'success'; completed_at?: string; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "batches progress",
        "example": "nimble batches progress \\\n  --api-key 'My API Key' \\\n  --batch-id 123e4567-e89b-12d3-a456-426614174000"
      },
      "http": {
        "example": "curl https://sdk.nimbleway.com/v1/batches/$BATCH_ID/progress \\\n    -H \"Authorization: Bearer $NIMBLE_API_KEY\""
      }
    }
  }
];
