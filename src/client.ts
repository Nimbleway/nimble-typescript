...
import { ExtractAsyncParams, ExtractAsyncResponse, ExtractBatchParams, ExtractBatchResponse, ExtractParams, ExtractResponse, MapParams, MapResponse, SearchParams, SearchResponse } from './resources/top-level';
import { APIPromise } from './core/api-promise';
import { Agent, AgentGenerateParams, AgentGenerateResponse, AgentGetGenerationResponse, AgentGetResponse, AgentListParams, AgentListResponse, AgentPublishParams, AgentPublishResponse, AgentRunAsyncParams, AgentRunAsyncResponse, AgentRunBatchParams, AgentRunBatchResponse, AgentRunParams, AgentRunResponse } from './resources/agent';
import { BatchGetResponse, BatchProgressResponse, Batches } from './resources/batches';
import { Crawl, CrawlListParams, CrawlListResponse, CrawlRunParams, CrawlRunResponse, CrawlStatusResponse, CrawlTerminateResponse } from './resources/crawl';
import { TaskGetResponse, TaskListParams, TaskListResponse, TaskResultsResponse, Tasks } from './resources/tasks';
...
export class Nimble {
  ...
  constructor({
    ...
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('NIMBLE_LOG'), 'process.env[\'NIMBLE_LOG\']', this) ?? defaultLogLevel;
