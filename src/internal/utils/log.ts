...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Nimble): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Nimble): Logger {
