...
export class Crawl extends APIResource {
   ...
   * @example
   * ```ts
   * const crawls = await client.crawl.list('status', {
   *   query_status: 'pending',
   * });
   * ```
   */
  list(pathStatus: string, query: CrawlListParams, options?: RequestOptions): APIPromise<CrawlListResponse> {
    return this._client.get(path`/v1/crawl?status=${pathStatus}`, { query, ...options });
  }
   ...
   * ```
   */
  root(body: CrawlRootParams, options?: RequestOptions): APIPromise<CrawlRootResponse> {
...
export namespace CrawlListResponse {
  ...
  export namespace Data {
    export interface Options {
       ...
       */
      callback?: Options.UnionMember0 | string;
      ...
      extract_options?: Options.ExtractOptions;
    ...
    export namespace Options {
      ...
      export interface ExtractOptions {
         ...
         */
        debug_options: { [key: string]: unknown };
        ...
        render_options?: { [key: string]: unknown };
...
export interface CrawlRootResponse {
  id: string;
...
export interface CrawlListParams {
   ...
   */
  query_status: 'pending' | 'in_progress' | 'completed' | 'failed' | 'canceled';
...
export interface CrawlRootParams {
  /**
   * Url to crawl.
   */
  url: string;
   ...
   * Webhook configuration for receiving crawl results.
   */
  callback?: CrawlRootParams.UnionMember0 | string;
  ...
  extract_options?: CrawlRootParams.ExtractOptions;
...
export namespace CrawlRootParams {
  export interface UnionMember0 {
    /**
     * Webhook URL to receive crawl results.
     */
  ...
  export interface ExtractOptions {
     ...
     * Debug and troubleshooting options for the request
     */
    debug_options: ExtractOptions.DebugOptions;
