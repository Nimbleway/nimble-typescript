...
export class Extract extends APIResource {
  ...
  async(body: ExtractAsyncParams, options?: RequestOptions): APIPromise<ExtractAsyncResponse> {
    return this._client.post('/v1/extract/async', { body, ...options });
  }
   ...
   * @example
   * ```ts
   * const response = await client.extract.extract({
   *   url: 'url',
   * });
   * ```
   */
  extract(body: ExtractExtractParams, options?: RequestOptions): APIPromise<ExtractExtractResponse> {
...
export interface ExtractExtractResponse {
  data: ExtractExtractResponse.Data;

  metadata: ExtractExtractResponse.Metadata;
  ...
  debug?: ExtractExtractResponse.Debug;

  /**
   * Pagination information if applicable.
   */
  pagination?: ExtractExtractResponse.NextPageParams | Array<ExtractExtractResponse.UnionMember1>;
...
export namespace ExtractExtractResponse {
...
export interface ExtractAsyncParams {
  ...
  browser_actions?: Array<
    | ExtractAsyncParams.AutoScrollAction
    | ExtractAsyncParams.ClickAction
    | ExtractAsyncParams.EvalAction
    | ExtractAsyncParams.FetchAction
    | ExtractAsyncParams.FillAction
    | ExtractAsyncParams.GetCookiesAction
    | ExtractAsyncParams.GotoAction
    | ExtractAsyncParams.PressAction
    | ExtractAsyncParams.ScreenshotAction
    | ExtractAsyncParams.ScrollAction
    | ExtractAsyncParams.WaitAction
    | ExtractAsyncParams.WaitForElementAction
    | ExtractAsyncParams.WaitForNavigationAction
  >;
   ...
   */
  metadata?: ExtractAsyncParams.Metadata;
   ...
   */
  query_template?: ExtractAsyncParams.QueryTemplate;
  ...
  render_options?: ExtractAsyncParams.RenderOptions;
   ...
   */
  template?: ExtractAsyncParams.Template;
   ...
   */
  userbrowser_creation_template_rendered?: ExtractAsyncParams.UserbrowserCreationTemplateRendered;
}
...
export interface ExtractExtractParams {
  /**
   * Target URL to scrape
   */
  url: string;
   ...
   * Browser type to emulate
   */
  browser?: 'chrome' | 'firefox' | ExtractExtractParams.UnionMember1;

  /**
   * Array of browser automation actions to execute sequentially
   */
  browser_actions?: Array<
    | ExtractExtractParams.AutoScrollAction
    | ExtractExtractParams.ClickAction
    | ExtractExtractParams.EvalAction
    | ExtractExtractParams.FetchAction
    | ExtractExtractParams.FillAction
    | ExtractExtractParams.GetCookiesAction
    | ExtractExtractParams.GotoAction
    | ExtractExtractParams.PressAction
    | ExtractExtractParams.ScreenshotAction
    | ExtractExtractParams.ScrollAction
    | ExtractExtractParams.WaitAction
    | ExtractExtractParams.WaitForElementAction
    | ExtractExtractParams.WaitForNavigationAction
  >;
   ...
   * Browser cookies as array of cookie objects
   */
  cookies?: Array<ExtractExtractParams.UnionMember0> | string;
   ...
   * Structured metadata about the request execution context
   */
  metadata?: ExtractExtractParams.Metadata;
   ...
   * Filters for capturing network traffic
   */
  network_capture?: Array<ExtractExtractParams.NetworkCapture>;
   ...
   * Query template configuration for structured data extraction
   */
  query_template?: ExtractExtractParams.QueryTemplate;
  ...
  render_options?: ExtractExtractParams.RenderOptions;
  ...
  session?: ExtractExtractParams.Session;
   ...
   * Userbrowser creation template configuration
   */
  template?: ExtractExtractParams.Template;
   ...
   * Pre-rendered userbrowser creation template configuration
   */
  userbrowser_creation_template_rendered?: ExtractExtractParams.UserbrowserCreationTemplateRendered;
}

export namespace ExtractExtractParams {
  export interface UnionMember1 {
    name: 'chrome' | 'firefox';
